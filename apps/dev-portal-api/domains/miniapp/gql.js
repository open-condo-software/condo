...
const B2B_APP_FIELDS = `{ name developer developerUrl shortDescription detailedDescription category contextDefaultStatus logo { publicUrl originalFilename } ${getEnvironmentalFieldsSelection(['oidcClientId', 'appUrl', 'modifiedAt'])} ${B2B_APP_PERMISSIONS_FIELDS} ${COMMON_FIELDS} ${EXPORT_FIELDS} }`
