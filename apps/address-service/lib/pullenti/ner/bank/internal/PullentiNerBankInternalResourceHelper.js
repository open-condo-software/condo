...
const PullentiNerBankPropertiesResources = require("./../properties/PullentiNerBankPropertiesResources");
...
class PullentiNerBankInternalResourceHelper {
    ...
    static getBytes(name) {
        ...
        let names = PullentiNerBankPropertiesResources.getNames();
        for (const n of names) {
            if (Utils.endsWithString(n, name, true)) {
                ...
                try {
                    let inf = PullentiNerBankPropertiesResources.getResourceInfo(n);
                    if (inf === null) 
                        continue;
                    let stream = PullentiNerBankPropertiesResources.getStream(n); 
                    try {
    ...
    static getString(name) {
        let arr = PullentiNerBankInternalResourceHelper.getBytes(name);
        if (arr === null) 
            return null;
...
module.exports = PullentiNerBankInternalResourceHelper