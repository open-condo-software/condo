...
class PullentiNerCorePropertiesResources {
...
PullentiNerCorePropertiesResources.names = ["MoneyEN.csv", "MoneyUA.csv", "Money.csv", "unknown.png"]; 

module.exports = PullentiNerCorePropertiesResources