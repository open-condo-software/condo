...
const PullentiNerCorePropertiesResources = require("./../properties/PullentiNerCorePropertiesResources");
...
class PullentiNerCoreInternalResourceHelper {
    ...
    static getBytes(name) {
        ...
        let names = PullentiNerCorePropertiesResources.getNames();
        for (const n of names) {
            if (Utils.endsWithString(n, name, true)) {
                ...
                try {
                    let inf = PullentiNerCorePropertiesResources.getResourceInfo(n);
                    if (inf === null) 
                        continue;
                    let stream = PullentiNerCorePropertiesResources.getStream(n); 
                    try {
    ...
    static getString(name) {
        let arr = PullentiNerCoreInternalResourceHelper.getBytes(name);
        if (arr === null) 
            return null;
...
module.exports = PullentiNerCoreInternalResourceHelper