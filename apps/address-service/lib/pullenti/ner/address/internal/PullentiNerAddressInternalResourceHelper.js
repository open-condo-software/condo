...
const PullentiNerAddressPropertiesResources = require("./../properties/PullentiNerAddressPropertiesResources");
...
class PullentiNerAddressInternalResourceHelper {
    ...
    static getBytes(name) {
        ...
        let names = PullentiNerAddressPropertiesResources.getNames();
        for (const n of names) {
            if (Utils.endsWithString(n, name, true)) {
                ...
                try {
                    let inf = PullentiNerAddressPropertiesResources.getResourceInfo(n);
                    if (inf === null) 
                        continue;
                    let stream = PullentiNerAddressPropertiesResources.getStream(n); 
                    try {
    ...
    static getString(name) {
        let arr = PullentiNerAddressInternalResourceHelper.getBytes(name);
        if (arr === null) 
            return null;
...
module.exports = PullentiNerAddressInternalResourceHelper