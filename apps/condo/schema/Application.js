...
const ApplicationClassifier = new GQLListSchema('ApplicationClassifier', {
    schemaDoc: 'Application typification/classification. We have a organization specific classification. We check the application attrs differently depending on the classifier',
    fields: {
        dv: DV_FIELD,
        sender: SENDER_FIELD,
...
const ApplicationStatus = new GQLListSchema('ApplicationStatus', {
    schemaDoc: 'Application status. We have a organization specific statuses',
    fields: {
        dv: DV_FIELD,
        sender: SENDER_FIELD,
        ...
        type: {
            ...
            schemaDoc: 'Application status. You should also increase `statusReopenedCounter` if you want to reopen application',
...
const ApplicationSource = new GQLListSchema('ApplicationSource', {
    schemaDoc: 'Application source. Income call, mobile app, external system, ...',
    fields: {
        dv: DV_FIELD,
        sender: SENDER_FIELD,
...
const Application = new GQLListSchema('Application', {
    fields: {
        dv: DV_FIELD,
        sender: SENDER_FIELD,
        ...
        number: {
            ...
            isRequired: false,
            schemaDoc: 'Autogenerated Application human readable ID',
        ...
        // Intercom code
        property: {
            schemaDoc: 'Property related to the Application',
            type: Relationship,
            ref: 'Property',
            isRequired: true,
            knexOptions: { isNotNullable: true }, // Relationship only!
