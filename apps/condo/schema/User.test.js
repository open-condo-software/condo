...
const { EMAIL_ALREADY_REGISTERED_ERROR } = require('../consts/errors')
const { REGISTER_NEW_USER_MUTATION } = require('./User.gql')
const { EMPTY_PASSWORD_ERROR } = require('../consts/errors')
const { WRONG_EMAIL_ERROR } = require('../consts/errors')
const { WRONG_PASSWORD_ERROR } = require('../consts/errors')
