    ...
    mutations: [
        {
            ...
            resolver: async (parent, /** ValidateQRCodeInputArgs */ args, context) => {
                ...
                const billingContexts = await find('BillingIntegrationOrganizationContext', {
                    id_in: [...new Set(billingAccounts.map(billingAccount => billingAccount.context))],
                    status: BILLING_CONTEXT_FINISHED_STATUS,
                    deletedAt: null,
                    integration: {
                        deletedAt: null,
                ...
                if (acquiringContexts.length === 0) throw new GQLError(ERRORS.NO_ACQUIRING_CONTEXT, context)
