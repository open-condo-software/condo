 ...
 * @param {array} approvedRecipientsIds a list of BillingRecipient ids which are approved
 * @param {array} approvedContextIds a list of BillingIntegrationOrganizationContext ids which associated AcquiringIntegrationContext is approved
 * @return {Promise<*>}
 */
async function makeBillingReceiptsPayable (
    ...
    for (const billingReceipt of billingReceipts) {
        ...
        if (!(approvedRecipientsIds.includes(recipientId))) {
            await updateTestBillingRecipient(client, recipientId, {
                isApproved: true,
            })
            approvedRecipientsIds.push(recipientId)
        }
        ...
        if (!(approvedContextIds.includes(contextId))) {
            ...
            approvedContextIds.push(contextId)
        }
    }

    return billingReceipts, approvedContextIds, approvedRecipientsIds
}
...
describe('AllResidentBillingReceipts', () => {
    ...
    describe('resident should be able to get all needed fields', () => {
        ...
        beforeAll(async () => {
            ...
            await makeBillingReceiptsPayable(receipt)
