...
const { createTestBillingIntegration, createTestBillingReceipt, updateTestBillingReceipt, ResidentBillingReceipt } = require('@condo/domains/billing/utils/testSchema')
    ...
    describe('user with valid serviceAccount', () => {
        ...
        describe('in case of multiple billingRecipients', () => {
            it('gets result filtered by accountId and recipientId', async () => {
                ...
                const WATER_RECIPIENT = createValidRecipient({ name: 'Water & co' })
                const ELECTRICITY_RECIPIENT = createValidRecipient({ name: 'Electricity & co' })
