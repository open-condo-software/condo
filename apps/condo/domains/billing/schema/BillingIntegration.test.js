import { expectToThrowAuthenticationErrorToObjects } from '../../common/utils/testSchema'
...
const { expectToThrowAccessDeniedErrorToObj, expectToThrowAuthenticationErrorToObj } = require('../../common/utils/testSchema')
