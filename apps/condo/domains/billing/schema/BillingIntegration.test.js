...
describe('BillingIntegration', () => {
    test('user: create BillingIntegration', async () => {
        ...
        const [obj, attrs] = await createTestBillingIntegration(client)  // TODO(codegen): write 'user: create BillingIntegration' test
    ...
    test('anonymous: create BillingIntegration', async () => {
        ...
        try {
            await createTestBillingIntegration(client)  // TODO(codegen): check the 'anonymous: create BillingIntegration' test!
        } catch (e) {
    ...
    test('user: read BillingIntegration', async () => {
        ...
        const [obj, attrs] = await createTestBillingIntegration(admin)  // TODO(codegen): check create function!

        const client = await makeClient()  // TODO(codegen): use truly useful client!
        const objs = await BillingIntegration.getAll(client)

        // TODO(codegen): check 'user: read BillingIntegration' test!
    ...
    test('user: update BillingIntegration', async () => {
        const admin = await makeLoggedInAdminClient()
        const [objCreated] = await createTestBillingIntegration(admin)  // TODO(codegen): check create function!

        const client = await makeClient()  // TODO(codegen): use truly useful client!
        const payload = {}  // TODO(codegen): change the 'user: update BillingIntegration' payload
        const [objUpdated, attrs] = await updateTestBillingIntegration(client, objCreated.id, payload)

        // TODO(codegen): white checks for 'user: update BillingIntegration' test
    ...
    test('anonymous: update BillingIntegration', async () => {
        ...
        const client = await makeClient()
        const payload = {}  // TODO(codegen): change the 'anonymous: update BillingIntegration' payload
        try {
    ...
    test('user: delete BillingIntegration', async () => {
        ...
        const client = await makeClient()  // TODO(codegen): use truly useful client!
        try {
            // TODO(codegen): check 'user: delete BillingIntegration' test!
    ...
    test('anonymous: delete BillingIntegration', async () => {
        ...
        const client = await makeClient()
        try {
            // TODO(codegen): check 'anonymous: delete BillingIntegration' test!
            await BillingIntegration.delete(client, objCreated.id)
        } catch (e) {
            expect(e.errors[0]).toMatchObject({
                'message': 'You do not have access to this resource',
