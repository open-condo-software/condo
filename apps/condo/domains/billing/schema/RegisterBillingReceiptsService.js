...
const { sortPeriodFunction, loadReceiptsFromCache, saveReceiptsToCache } = require('@condo/domains/billing/schema/resolvers/utils')
            ...
            resolver: async (parent, args, context = {}) => {
                ...
                if (receiptsPeriods.length) {
                    ...
                    if (!newerReceiptsCount) {
                        ...
                        if (currentPeriodReceiptsCount && currentPeriodReceiptsCount !== get(context, 'lastReport.totalReceipts', 0)) {
