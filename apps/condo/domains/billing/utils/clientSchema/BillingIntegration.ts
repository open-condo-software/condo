...
const FIELDS = ['id', 'deletedAt', 'createdAt', 'updatedAt', 'createdBy', 'updatedBy', 'name', 'detailsTitle', 'detailsText', 'detailsConfirmButtonText', 'detailsInstructionButtonText', 'detailsInstructionButtonLink', 'shortDescription', 'contextDefaultStatus', 'billingPageTitle', 'currency', 'dataFormat', 'isHidden']
const RELATIONS = []
