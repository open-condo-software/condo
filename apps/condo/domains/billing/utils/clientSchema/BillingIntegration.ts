...
const FIELDS = ['id', 'deletedAt', 'createdAt', 'updatedAt', 'createdBy', 'updatedBy', 'name', 'shortDescription', 'about', 'logo', 'developer', 'partnerUrl', 'instruction', 'connectedMessage', 'appUrl', 'detailsTitle', 'detailsConfirmButtonText', 'detailsInstructionButtonText', 'detailsInstructionButtonLink', 'contextDefaultStatus', 'billingPageTitle', 'currency', 'dataFormat', 'isHidden', 'availableOptions']
const RELATIONS = []
