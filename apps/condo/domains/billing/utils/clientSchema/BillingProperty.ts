...
import { BillingProperty, BillingPropertyUpdateInput, QueryAllBillingPropertiesArgs } from '../../../../schema'

const FIELDS = ['id', 'deletedAt', 'createdAt', 'updatedAt', 'createdBy', 'updatedBy', 'context', 'importId', 'bindingId', 'address', 'raw', 'meta']
