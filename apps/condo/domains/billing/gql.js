...
const BILLING_INTEGRATION_ORGANIZATION_CONTEXT_FIELDS = `{ integration { id name billingPageTitle } organization { id name } settings state status lastReport ${COMMON_FIELDS} }`
