...
const BILLING_INTEGRATION_ORGANIZATION_CONTEXT_FIELDS = `{ integration { id name billingPageTitle currencyCode dataFormat ${BILLING_INTEGRATION_DATA_FORMAT_FIELDS} availableOptions { options { name billingPageTitle } } } organization { id name } settings state status lastReport integrationOption ${COMMON_FIELDS} }`
