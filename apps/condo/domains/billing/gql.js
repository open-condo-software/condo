...
const ALL_RESIDENT_BILLING_RECEIPTS = gql`
    query allResidentBillingReceipts ($data: allResidentsBillingReceiptInput!) {
        objs: allResidentBillingReceipts(data: $data) {
            id,
            dv,
            recipient,
            period,
