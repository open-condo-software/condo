...
const BILLING_INTEGRATION_OPTIONS_FIELDS = '{ title options { name displayName billingPageTitle descriptionDetails { detailsText detailsLink } } }'
...
const BILLING_INTEGRATION_ORGANIZATION_CONTEXT_FIELDS = `{ integration { id name billingPageTitle currencyCode dataFormat availableOptions { options { name billingPageTitle } } } organization { id name } settings state status lastReport integrationOption ${COMMON_FIELDS} }`
