...
const BILLING_RECEIPT_FIELDS = `{ context ${BILLING_INTEGRATION_ORGANIZATION_CONTEXT_FIELDS} importId property { id } account { id } recipient { id } period raw toPay printableNumber toPayDetails services ${COMMON_FIELDS} }`
