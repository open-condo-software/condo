...
const BILLING_RECEIPT_TO_PAY_DETAILS_FIELDS = '{ charge formula balance recalculation privilege penalty }'
const BILLING_RECEIPT_SERVICE_TO_PAY_DETAILS_FIELDS = BILLING_RECEIPT_TO_PAY_DETAILS_FIELDS.replace('}', 'volume tariff measure }')
const BILLING_RECEIPT_SERVICE_FIELDS = `{ id name toPay toPay toPayDetails ${BILLING_RECEIPT_SERVICE_TO_PAY_DETAILS_FIELDS} }`
const BILLING_RECEIPT_RECIPIENT_FIELDS = '{ tin iec bic bankAccount }'
const BILLING_RECEIPT_FIELDS = `{ context ${BILLING_INTEGRATION_ORGANIZATION_CONTEXT_FIELDS} importId property { id, address } account { id, number } period raw toPay printableNumber toPayDetails ${BILLING_RECEIPT_TO_PAY_DETAILS_FIELDS} services ${BILLING_RECEIPT_SERVICE_FIELDS} recipient ${BILLING_RECEIPT_RECIPIENT_FIELDS} ${COMMON_FIELDS} }`
