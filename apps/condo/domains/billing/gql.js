...
const VALIDATE_QRCODE_MUTATION = gql`
    mutation validateQRCode ($data: ValidateQRCodeInput!) {
        result: validateQRCode(data: $data) { qrCodeFields lastReceiptData { id period toPay } explicitFees { explicitServiceCharge explicitFee } amount acquiringIntegrationHostUrl }
    }
`
