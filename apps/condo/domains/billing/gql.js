...
const BILLING_RECIPIENT_FIELDS = `{ organization { id } context { id } importId tin iec bic bankAccount paymentOrder approved meta name ${COMMON_FIELDS} }`
