...
const { RECIPIENT_FIELDS_DEFINITION } = require('@condo/domains/acquiring/schema/fields/Recipient')
...
const BILLING_RECEIPT_FIELDS = `{ ${BILLING_RECEIPT_COMMON_FIELDS} file { id file { id filename originalFilename publicUrl mimetype } controlSum } acquiringIntegrationId acquiringHostUrl canGroupReceipts currencyCode balanceUpdatedAt amountDistribution { ${AMOUNT_DISTRIBUTION_SUBFIELDS} } }`
