...
const BILLING_INTEGRATION_OPTIONS_FIELDS = '{ title options { name billingPageTitle descriptionDetails { detailsText detailsLink } } }'
...
const BILLING_INTEGRATION_ORGANIZATION_CONTEXT_FIELDS = `{ integration { id name billingPageTitle currencyCode dataFormat } organization { id name } settings state status lastReport integrationOption { name } ${COMMON_FIELDS} }`
