...
const BILLING_INTEGRATION_ORGANIZATION_CONTEXT_FIELDS = `{ integration { id name billingPageTitle currencyCode dataFormat } organization { id name } settings state status lastReport integrationOption ${COMMON_FIELDS} }`
