...
const BILLING_INTEGRATION_FIELDS = `{ name shortDescription gallery price detailedDescription about logo { publicUrl } developer partnerUrl appUrl contextDefaultStatus dataFormat ${BILLING_INTEGRATION_DATA_FORMAT_FIELDS} isHidden ${COMMON_FIELDS} }`
