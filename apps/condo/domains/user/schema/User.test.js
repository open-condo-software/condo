...
const { WRONG_PASSWORD_ERROR, EMPTY_PASSWORD_ERROR, WRONG_EMAIL_ERROR } = require('@condo/domains/user/constants/errors')

describe('REGISTER', () => {
    test('registration attempt with landline phone number', async () => {
        const client = await makeClient()

        const { errors } = await registerNewUser(client, {
...
const USER_ID_REGEXP = /^[A-Za-z0-9-_]+$/
...
describe('SIGNIN', () => {
    test('anonymous: SIGNIN_MUTATION', async () => {
        ...
        expect(data.auth.user.id).toMatch(USER_ID_REGEXP)
...
describe('User utils', () => {
    test('createUser()', async () => {
        ...
        expect(user.id).toMatch(USER_ID_REGEXP)
