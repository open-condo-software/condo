...
describe('ConfirmPhoneAction Service', () => {
    it('can be created by Anonymous', async () => {
        ...
        } = await client.mutate(START_CONFIRM_PHONE_MUTATION, { data: createInput })
    ...
    it('gives to Anonymous phone number when he asks with token', async () => {
        ...
        const {
            data: {
                result: { phone: phoneFromAction },
            },
        } = await client.query(GET_PHONE_BY_CONFIRM_PHONE_TOKEN_QUERY, { data: getInput })
