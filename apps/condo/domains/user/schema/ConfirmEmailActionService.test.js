...
const { confirmEmailActionByTestClient } = require('@condo/domains/user/utils/testSchema')
...
describe('ConfirmEmailActionService', () => {
    test('user: execute', async () => {
        ...
        const payload = {}  // TODO(codegen): change the 'user: update ConfirmEmailActionService' payload
        const [data, attrs] = await confirmEmailActionByTestClient(client, payload)
    ...
    test('anonymous: execute', async () => {
        ...
        await expectToThrowAuthenticationErrorToObjects(async () => {
            await confirmEmailActionByTestClient(client)
        })
    })
    ...
    test('admin: execute', async () => {
        ...
        const payload = {}  // TODO(codegen): change the 'user: update ConfirmEmailActionService' payload
        const [data, attrs] = await confirmEmailActionByTestClient(admin, payload)
