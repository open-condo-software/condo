...
if (scriptLifecycleName !== 'build:static' && scriptLifecycleName !== 'build' && !SUPPORT_EMAIL_MOBILE) throw new Error('support_email_mobile variable not found. help_requisites must be specified in .env')
