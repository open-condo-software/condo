...
const { WRONG_EMAIL_FORMAT, COMMON_ERRORS } = require('@condo/domains/common/constants/errors')
...
const ERRORS = {
    ...
    CAPTCHA_CHECK_FAILED: {
        query: 'authenticateUserWithEmailAndPassword',
    ...
    mutations: [
        {
            ...
            resolver: async (parent, args, context) => {
                ...
                const {
                    ...
                    captcha,
                    dv = 1,
                    sender = { dv: 1, fingerprint: 'auth-by-email-and-password' },
                    userType = STAFF,
                } = data
