...
const RegisterNewServiceUserService = new GQLCustomSchema('RegisterNewServiceUserService', {
    types: [
        ...
        {
            access: true,
            type: 'type RegisterNewServiceUserOutput { id: ID!, email: String! }',
        },
    ],
    ...
    mutations: [
        {
            ...
            resolver: async (parent, args, context) => {
                const userData = {
                    ...
                    // NOTE: There are 2 factors of verification:
                    // 1. Password is sent by email, generated by this function
                    // 2. For dev-portal users, email is additionally verified before registration
