...
const { expectToThrowAccessDeniedErrorToResult, expectToThrowMutationError, expectToThrowAuthenticationErrorToResult } = require('@condo/domains/common/utils/testSchema')
...
describe('ResetUserService', () => {
    test('support can reset user', async () => {
        ...
        const result = await resetUserByTestClient(support, payload)
