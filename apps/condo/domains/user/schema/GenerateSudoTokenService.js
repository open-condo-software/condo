...
const GenerateSudoTokenService = new GQLCustomSchema('GenerateSudoTokenService', {
    types: [
        ...
        {
            access: true,
            type: 'input GenerateSudoTokenAuthFactorsInput { confirmPhoneToken: String, confirmEmailToken: String, password: String }',
        },
        {
            access: true,
    ...
    mutations: [
        {
            ...
            resolver: async (parent, args, context) => {
                ...
                if (validation.confirmPhoneAction) {
                    await ConfirmPhoneAction.update(context, validation.confirmPhoneAction.id, updateData)
                }

                if (validation.confirmEmailAction) {
                    await ConfirmEmailAction.update(context, validation.confirmEmailAction.id, updateData)
                }
