...
const WRONG_LOGIN_ERROR = '[passwordAuth:identity:notFound'
...
const INVALID_CONFIRM_TYPE = 'INVALID_CONFIRM_TYPE'
const TOKEN_NOT_FOUND = 'TOKEN_NOT_FOUND'
const USER_NOT_FOUND = 'USER_NOT_FOUND'
const USER_BY_PHONE_NOT_FOUND = 'USER_BY_PHONE_NOT_FOUND'
const USER_BY_EMAIL_NOT_FOUND = 'USER_BY_EMAIL_NOT_FOUND'
...
const CONFIRM_EMAIL_ACTION_EXPIRED = '[confirm:email:expired'
const CONFIRM_PHONE_SMS_CODE_EXPIRED = '[confirm:phone:smscode:expired'
const CONFIRM_EMAIL_CODE_EXPIRED = '[confirm:email:emailcode:expired'
...
const CONFIRM_EMAIL_CODE_VERIFICATION_FAILED = '[confirm:email:emailcode:verify:failed'
...
const CONFIRM_EMAIL_CODE_MAX_RETRIES_REACHED = '[confirm:email:emailcode:tooManyRequests'
...
const ERRORS = {
    ...
    UNABLE_TO_FIND_CONFIRM_EMAIL_ACTION: {
        mutation: 'registerNewUser',
        variable: ['data', 'confirmEmailActionToken'],
        code: 'BAD_USER_INPUT',
        type: UNABLE_TO_FIND_CONFIRM_EMAIL_ACTION,
        message: 'Unable to find confirm email action',
        messageForUser: 'api.user.registerNewUser.UNABLE_TO_FIND_CONFIRM_EMAIL_ACTION',
    },
    WRONG_PHONE_FORMAT: {
        mutation: 'registerNewUser',
        variable: ['data', 'phone'],
