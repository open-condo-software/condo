 ...
 * @return {Promise<{success: boolean}|{confirmPhoneAction?: {id: string, phone: string, isPhoneVerified: boolean}, confirmEmailAction?: {id: string, email: string, isEmailVerified: boolean}, success: boolean, user: *}|{success: boolean, _error: {is2FAEnabled: boolean, errorType: string, authChecks: {confirmEmailToken: ("skip"|"fail"|"success"), password: ("skip"|"fail"|"success"), confirmPhoneToken: ("skip"|"fail"|"success")}}}>}
 * @private
 */
 ...
 * @param {{ confirmPhoneToken?: string, confirmEmailToken?: string, password?: string }} authFactors
 * @return {Promise<{
 *   confirmPhoneAction?: {id: string, phone: string, isPhoneVerified: boolean},
 *   confirmEmailAction?: {id: string, email: string, isEmailVerified: boolean},
 *   success: boolean
 * }|{
 *   success: boolean,
 *   _error: {
 ...
 *     errorType: string,
 *     authChecks: {
 *       confirmEmailToken: ("skip"|"fail"|"success"),
 *       password: ("skip"|"fail"|"success"),
 *       confirmPhoneToken: ("skip"|"fail"|"success")
 *     }
 *   }
 * }|{
 *   success: boolean
