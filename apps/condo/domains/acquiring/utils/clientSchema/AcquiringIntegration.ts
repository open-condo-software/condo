...
const FIELDS = ['id', 'deletedAt', 'detailsTitle', 'detailsText', 'createdAt', 'updatedAt', 'createdBy', 'updatedBy', 'name', 'shortDescription', 'logo', 'developer', 'partnerUrl', 'instruction', 'connectedMessage', 'appUrl', 'canGroupReceipts', 'hostUrl']
