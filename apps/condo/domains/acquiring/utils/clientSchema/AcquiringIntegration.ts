...
const FIELDS = ['id', 'deletedAt', 'createdAt', 'updatedAt', 'createdBy', 'updatedBy', 'name', 'canGroupReceipts', 'hostUrl']
...
const { useObject, useObjects, useCreate, useUpdate, useDelete } = generateReactHooks<
    ...
    IAcquiringIntegrationFormState,
    IAcquiringIntegrationUIState,
    QueryAllAcquiringIntegrationsArgs
>(AcquiringIntegrationGQL, { convertToGQLInput, convertToUIState })
