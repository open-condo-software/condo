...
// LIST OF FIELDS, WHICH CAN BE CHANGED IF PAYMENT IS VIRTUAL
const VIRTUAL_PAYMENT_FIELDS = ['receipt', 'frozenReceipt', 'invoice', 'frozenInvoice']
const VIRTUAL_PAYMENT_CHANGEABLE_FIELDS = ['receipt', 'frozenReceipt']
