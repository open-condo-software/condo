...
// Old version of the SBOL_BINDING
const SBRF_SBOL_BINDING_PAYMENT_METHOD = 'SBRF_SBOL_BINDING'
const SBOL_BINDING_PAYMENT_METHOD = 'SBOL_BINDING'
...
const AVAILABLE_PAYMENT_METHODS = [
    ...
    SBRF_SBOL_BINDING_PAYMENT_METHOD,
    SBOL_BINDING_PAYMENT_METHOD,
]
...
const PAYMENT_REVERSED_STATUS = 'REVERSED'
...
const PAYMENT_TRANSITIONS = {
    ...
    [PAYMENT_DONE_STATUS]: [PAYMENT_ERROR_STATUS, PAYMENT_REVERSED_STATUS],
    [PAYMENT_REVERSED_STATUS]: [],
    [PAYMENT_ERROR_STATUS]: [],
}
...
const PAYMENT_REQUIRED_FIELDS = {
    ...
    [PAYMENT_REVERSED_STATUS]: ['reversalReason', 'reversedAt', 'reversedBy'],
    [PAYMENT_ERROR_STATUS]: [],
}

const DEFAULT_PAYMENT_FROZEN_FIELDS = ['amount', 'currencyCode', 'accountNumber', 'period', 'receipt', 'frozenReceipt', 'invoice', 'frozenInvoice', 'context', 'organization', 'recipientBic', 'recipientBankAccount', 'frozenDistribution', 'frozenSplits']
...
const PAYMENT_FROZEN_FIELDS = {
    ...
    [PAYMENT_REVERSED_STATUS]: [...DEFAULT_PAYMENT_FROZEN_FIELDS, 'multiPayment', 'explicitFee', 'explicitServiceCharge', 'implicitFee', 'reversalReason', 'reversedAt', 'reversedBy', 'reversalLedgerEntry'],
