...
const PAYMENT_TRANSITIONS = {
    [PAYMENT_INIT_STATUS]: [PAYMENT_DONE_STATUS, PAYMENT_PROCESSING_STATUS, PAYMENT_ERROR_STATUS],
    [PAYMENT_PROCESSING_STATUS]: [PAYMENT_DONE_STATUS, PAYMENT_ERROR_STATUS],
    [PAYMENT_DONE_STATUS]: [],
    [PAYMENT_ERROR_STATUS]: [],
}
