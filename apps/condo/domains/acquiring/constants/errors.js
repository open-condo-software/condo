...
const { ACQUIRING_INTEGRATION_EXTERNAL_IMPORT_TYPE } = require('./integration')
...
const MULTIPAYMENT_SEVERAL_PAYMENTS = `[multiPayment:payments] MultiPayment cannot be created with several payments for acquiring integration with type "${ACQUIRING_INTEGRATION_EXTERNAL_IMPORT_TYPE}"`
