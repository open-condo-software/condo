...
const PAYMENT_RULE_MARKET_SCOPE_INVALID_SKU_IDS = 'PAYMENT_RULE_MARKET_SCOPE_INVALID_SKU_IDS'
const PAYMENT_RULE_MARKET_SCOPE_MISSING_ALL_FIELDS = '[paymentRuleMarketScope:emptyFields] At least one field besides payment rule must be present'
const PAYMENT_RULE_MARKET_SCOPE_PROPERTY_AND_PAYMENT_RULE_ORGANIZATIONS_DOES_NOT_MATCH = '[paymentRuleMarketScope:property:organization:noMatch] Property must be of same organization, as payment rule'
