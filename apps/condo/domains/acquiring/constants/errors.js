...
const CANNOT_FIND_ALL_ORDERS = 'CANNOT_FIND_ALL_ORDERS'
const ORDERS_ARE_DELETED = 'ORDERS_ARE_DELETED'
const ORDERS_HAVE_NEGATIVE_TO_PAY_VALUE = 'ORDERS_HAVE_NEGATIVE_TO_PAY_VALUE'
const ORDER_HAS_DELETED_BILLING_INTEGRATION = 'ORDER_HAS_DELETED_BILLING_INTEGRATION'
...
const PAYMENT_NO_PAIRED_FROZEN_ORDER = 'PAYMENT_NO_PAIRED_FROZEN_ORDER'
const PAYMENT_NO_PAIRED_ORDER = 'PAYMENT_NO_PAIRED_ORDER'
const PAYMENT_ORDER_IS_LINKED = 'PAYMENT_ORDER_IS_LINKED'
const PAYMENT_RECEIPT_IS_LINKED = 'PAYMENT_RECEIPT_IS_LINKED'
