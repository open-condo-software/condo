...
const MULTIPLE_ACQUIRING_INTEGRATION = 'MULTIPLE_ACQUIRING_INTEGRATION'
const MULTIPLE_ACTIVE_ACQUIRING_INTEGRATION_CONTEXTS = 'MULTIPLE_ACTIVE_ACQUIRING_INTEGRATION_CONTEXTS'
...
const CANNOT_FIND_ALL_INVOICES = 'CANNOT_FIND_ALL_INVOICES'
const INVALID_REQUEST_MODE = 'INVALID_REQUEST_MODE'
const INVOICES_ARE_NOT_PUBLISHED = 'INVOICES_ARE_NOT_PUBLISHED'
const INVOICES_NOT_OWNED_BY_USER = 'INVOICES_NOT_OWNED_BY_USER'
...
const FULL_PAYMENT_AMOUNT_MISMATCH = 'FULL_PAYMENT_AMOUNT_MISMATCH'
const MULTIPAYMENT_NON_DONE_PAYMENTS = 'MULTIPAYMENT_NON_DONE_PAYMENTS'
const MULTIPAYMENT_SEVERAL_PAYMENTS = 'MULTIPAYMENT_SEVERAL_PAYMENTS'
const MULTIPAYMENT_INVALID_STATUS = 'MULTIPAYMENT_INVALID_STATUS'
