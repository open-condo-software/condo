...
const PAYMENT_FIELDS = `{ amount amountWithImplicitFee explicitFee implicitFee currencyCode advancedAt accountNumber purpose frozenReceipt multiPayment { id } context { id } status ${COMMON_FIELDS} period organization { id } recipientBic recipientBankAccount }`
