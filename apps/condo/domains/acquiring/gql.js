...
const ACQUIRING_INTEGRATION_FIELDS = `{ name shortDescription logo { publicUrl } developer partnerUrl detailsTitle detailsText canGroupReceipts hostUrl supportedBillingIntegrations { id } ${COMMON_FIELDS} }`
