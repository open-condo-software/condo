...
const PAYMENTS_FILE_FIELDS = `{ number file { id originalFilename publicUrl mimetype } acquiringContext { id } externalId account dateBegin dateEnd dateLoad uploadedRecords amount amountBring registryName status bankComment fileName paymentOrder ${COMMON_FIELDS} }`
