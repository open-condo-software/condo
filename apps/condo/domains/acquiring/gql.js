...
const ACQUIRING_INTEGRATION_FIELDS = `{ name shortDescription detailedDescription about logo { publicUrl } developer partnerUrl appUrl canGroupReceipts hostUrl supportedBillingIntegrations { id } ${COMMON_FIELDS} }`
