...
const ACQUIRING_INTEGRATION_FIELDS = `{ name minimumPaymentAmount maximumPaymentAmount setupTitle setupUrl canGroupReceipts hostUrl supportedBillingIntegrationsGroup vatPercentOptions ${COMMON_FIELDS} logo { publicUrl } shortDescription displayPriority }`
