...
const ACQUIRING_INTEGRATION_FIELDS = `{ name minimumPaymentAmount maximumPaymentAmount setupUrl canGroupReceipts hostUrl supportedBillingIntegrationsGroup vatPercentOptions ${COMMON_FIELDS} logo { publicUrl } shortDescription }`
