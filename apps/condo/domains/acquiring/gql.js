...
const ACQUIRING_INTEGRATION_FIELDS = `{ name shortDescription logo { publicUrl } developer partnerUrl instruction connectedMessage appUrl detailsTitle canGroupReceipts hostUrl supportedBillingIntegrations { id } ${COMMON_FIELDS} }`
