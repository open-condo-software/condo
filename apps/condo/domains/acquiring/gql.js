...
const ACQUIRING_INTEGRATION_FIELDS = `{ name shortDescription logo { publicUrl } developer partnerUrl instruction appUrl detailsTitle canGroupReceipts hostUrl supportedBillingIntegrations { id } ${COMMON_FIELDS} }`
