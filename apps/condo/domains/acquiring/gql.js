...
const ACQUIRING_INTEGRATION_FIELDS = `{ name shortDescription gallery price detailedDescription logo { publicUrl } developer partnerUrl appUrl canGroupReceipts hostUrl supportedBillingIntegrationsGroup ${COMMON_FIELDS} }`
...
const RECURRENT_PAYMENT_FIELDS = `{ status tryCount state billingReceipts { id } recurrentPaymentContext { id } ${COMMON_FIELDS} }`
