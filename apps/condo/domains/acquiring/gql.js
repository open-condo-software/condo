...
const PAYMENT_BY_LINK_MUTATION = gql`
    mutation createPaymentByLink ($data: CreatePaymentByLinkInput!) {
        result: createPaymentByLink(data: $data) { multiPaymentId amount explicitFee totalAmount acquiringIntegrationHostUrl address addressMeta { ${ADDRESS_META_SUBFIELDS_QUERY_LIST} } unitType unitName accountNumber period }
    }
`
