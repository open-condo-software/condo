...
const { allCardBindingsByTestClient } = require('@condo/domains/acquiring/utils/testSchema')
 
describe('AllCardBindingsService', () => {
    test('user: execute', async () => {
        const client = await makeClient()  // TODO(codegen): use truly useful client!
        const payload = {}  // TODO(codegen): change the 'user: update AllCardBindingsService' payload
        const [data, attrs] = await allCardBindingsByTestClient(client, payload)
    ...
    test('admin: execute', async () => {
        ...
        const payload = {}  // TODO(codegen): change the 'user: update AllCardBindingsService' payload
        const [data, attrs] = await allCardBindingsByTestClient(admin, payload)
