    ...
    describe('Execute', () => {
        describe('Anonymous user', () => {
            ...
            test('From receipt data', async () => {
                ...
                paymentLink.searchParams.set('su', callbackUrls.successUrl)
                paymentLink.searchParams.set('fu', callbackUrls.failureUrl)
                paymentLink.searchParams.set('cc', receipt.currencyCode)
                paymentLink.searchParams.set('a', receipt.amount)
                paymentLink.searchParams.set('p', '2022-01-01')
                paymentLink.searchParams.set('an', receipt.accountNumber)
