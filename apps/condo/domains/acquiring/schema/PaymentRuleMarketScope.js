...
const PaymentRuleMarketScope = new GQLListSchema('PaymentRuleMarketScope', {
            ...
            hooks: {
                validateInput: async ({ resolvedData, fieldPath, addFieldValidationError }) => {
                    ...
                    if (paymentRule.organization !== property.organization) {
                        return addFieldValidationError(PAYMENT_RULE_MARKET_SCOPE_PROPERTY_AND_PAYMENT_RULE_ORGANIZATIONS_DOES_NOT_MATCH)
                    }
                },
            },
        },
    ...
    access: {
        read: access.canReadPaymentRuleMarketScopes,
        create: access.canManagePaymentRuleMarketScopes,
        update: access.canManagePaymentRuleMarketScopes,
        delete: false,
        auth: true,
    },
})
...
module.exports = {
    PaymentRuleMarketScope: PaymentRuleMarketScope,
}
