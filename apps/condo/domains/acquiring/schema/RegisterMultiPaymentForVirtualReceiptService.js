...
const RegisterMultiPaymentForVirtualReceiptService = new GQLCustomSchema('RegisterMultiPaymentForVirtualReceiptService', {
    types: [
        {
            access: true,
            type: 'enum RegisterMultiPaymentVirtualReceiptCurrency { RUB, USD }',
        },
        {
            access: true,
            type: 'input RegisterMultiPaymentVirtualReceiptRecipientInput { bic: String!, bankAccount: String!, accountNumber: String! }',
        },
        {
            access: true,
    ...
    mutations: [
        {
            ...
            resolver: async (parent, args, context) => {
                ...
                const { currencyCode, amount, period, recipient: { bic, bankAccount, accountNumber } } = receipt
