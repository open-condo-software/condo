...
const MULTIPAYMENT_DECLINED_STATUS = 'DECLINED'
const MULTIPAYMENT_ERROR_STATUS = 'ERROR'

const MULTIPAYMENT_STATUSES = [
    MULTIPAYMENT_INIT_STATUS,
    MULTIPAYMENT_DONE_STATUS,
    MULTIPAYMENT_DECLINED_STATUS,
    MULTIPAYMENT_PROCESSING_STATUS,
    MULTIPAYMENT_ERROR_STATUS,
]

const MULTIPAYMENT_RECEIPT_FIELD_NAME = 'MultiPaymentReceiptField'
const MULTIPAYMENT_RECEIPT_INPUT_NAME = 'MultiPaymentReceiptFieldInput'
const MULTIPAYMENT_RECEIPTS_FIELD_NAME = '[MultiPaymentReceiptField!]!'
const MULTIPAYMENT_RECEIPTS_INPUT_NAME = '[MultiPaymentReceiptFieldInput!]!'
...
module.exports = {
    ...
    MULTIPAYMENT_DONE_STATUS,
    MULTIPAYMENT_INIT_STATUS,
    MULTIPAYMENT_RECEIPT_FIELD_NAME,
    MULTIPAYMENT_RECEIPT_INPUT_NAME,
    MULTIPAYMENT_RECEIPTS_FIELD_NAME,
    MULTIPAYMENT_RECEIPTS_INPUT_NAME,
}
