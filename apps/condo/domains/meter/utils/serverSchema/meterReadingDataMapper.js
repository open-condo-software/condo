const meterReadingDataMapper = ({ row = {}, constants = {} }) => ({
    header: {
        ru: ['Дата снятия', 'Адрес', 'Квартира', 'Услуга', 'Номер прибора', 'Место', 'Показание по тарифу №1', 'Показание по тарифу №2',
            'Показание по тарифу №3', 'Показание по тарифу №4', 'Житель', 'Источник'],
        en: ['Reading date', 'Address', 'Unit', 'Service', 'Meter number', 'Place', 'Reading from tariff №1', 'Reading from tariff №2',
