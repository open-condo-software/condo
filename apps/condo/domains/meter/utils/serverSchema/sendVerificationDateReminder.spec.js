...
const { sendVerificationDateReminder } = require('apps/condo/domains/meter/utils/serverSchema/sendVerificationDateReminder')
const { METER_VERIFICATION_DATE_REMINDER_TYPE } = require('apps/condo/domains/notification/constants/constants')
const { Message: MessageApi } = require('apps/condo/domains/notification/utils/serverSchema')


const { makeClientWithResidentAndMeter } = require('../testSchema')
