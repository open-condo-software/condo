...
const METER_FIELDS = `{ number numberOfTariffs installationDate commissioningDate verificationDate controlReadingsDate account organization { id } property { id } unitName place resource { id } ${COMMON_FIELDS} }`
