...
export function useTableColumns <T> (filterMetas: Array<FiltersMeta<T>>, meterPageType: MeterPageTypes = METER_PAGE_TYPES.meter) {
    ...
    const MeterReadingMessage = intl.formatMessage({ id: 'meter.meterReading' })
    ...
    const CustomPeriodMessage = intl.formatMessage({ id: 'meter.index.reportingPeriod.table.customPeriod' })
