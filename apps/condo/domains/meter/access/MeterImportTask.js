...
async function canReadMeterImportTasks ({ authentication: { item: user } }) {
...
async function canManageMeterImportTasks ({ authentication: { item: user }, originalInput, operation, context }) {
    if (!user) return throwAuthenticationError()
    if (user.deletedAt) return false
...
*/
module.exports = {
    canReadMeterImportTasks,
    canManageMeterImportTasks,
}
