...
const { PropertyOrganizationId } = require('@condo/domains/property/utils/serverSchema')
        ...
        resolveInput: async ({ context, operation, resolvedData }) => {
            if (operation === 'create') {
                if (!resolvedData.organization && resolvedData.property) {
                    const property = await PropertyOrganizationId.getOne(context, { id: resolvedData.property })
