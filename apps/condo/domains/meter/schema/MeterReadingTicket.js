...
const { AutoIncrementInteger } = require('@core/keystone/fields/AutoIncrementInteger/Implementation')
...
const MeterReadingTicket = new GQLListSchema('MeterReadingTicket', {
    schemaDoc: 'Ticket that contains the received meters readings',
    fields: {
        dv: DV_FIELD,
        sender: SENDER_FIELD,
