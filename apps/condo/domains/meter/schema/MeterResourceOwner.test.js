...
describe('MeterResourceOwner', () => {
    ...
    beforeAll(async () => {
        ...
        defaultPayload = { address: property.address }
    ...
    describe('CRUD tests', () => {
        describe('create', () => {
            ...
            test('resident can\'t', async () => {
                await expectToThrowAccessDeniedErrorToObj(async () => {
                    await createTestMeterResourceOwner(resident, organization, property, { address: property.address })
                })
            })
        ...
        describe('update', () => {
            ...
            test('resident can\'t', async () => {
                ...
                const [objCreated] = await createTestMeterResourceOwner(admin, newOrganization, resource, defaultPayload)

                await expectToThrowAccessDeniedErrorToObj(async () => {
                    await updateTestMeterResourceOwner(resident, objCreated.id, { organization: { connect: { id: organization.id } } })
                })
            })
        ...
        describe('read', () => {
            ...
            test('anonymous can\'t', async () => {
                const [organization] = await createTestOrganization(admin)
                await createTestMeterResourceOwner(admin, organization, resource, defaultPayload)
