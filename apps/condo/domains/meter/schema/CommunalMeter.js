...
const { CommunalMeter: CommunalMeterAPI } = require('@condo/domains/meter/utils/serverSchema/index')
        ...
        number: {
            ...
            hooks: {
                validateInput: async ({ context, operation, existingItem, resolvedData, fieldPath, addFieldValidationError }) => {
                    ...
                    if (operation === 'create') {
                        metersWithSameResourceAndNumberInOrganization = await find('CommunalMeter', {
                            number: value,
                        ...
                        metersWithSameResourceAndNumberInOrganization = await CommunalMeterAPI.getAll(context, {
                            number: value,
        ...
        constraints: [
            {
                ...
                name: 'communalmeter_unique_organization_and_number',
            },
        ],
    },
    hooks: {
