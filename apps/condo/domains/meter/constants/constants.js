...
const EXTERNAL_INTEGRATION_READING_SOURCE_ID = '3450106c-2613-49e8-8d97-b3adf5edd189'
...
const COLD_AIR_METER_RESOURCE_ID = '4cb94217-14cb-4897-8b8f-891b781a1896'
const DRAINAGE_METER_RESOURCE_ID = 'ffc3f0c3-5044-4093-93ce-d7e92176dfe2'
...
const METER_READING_SOURCE_EXTERNAL_INTEGRATION_TYPE = 'external_integration'
...
const METER_READING_SOURCE_TYPES = [
    ...
    METER_READING_SOURCE_EXTERNAL_INTEGRATION_TYPE,
]
...
const METER_READING_MAX_VALUES_COUNT = 4
const PROPERTY_METER_READING_MAX_VALUES_COUNT = 4

const METER_READING_BILLING_STATUS_APPROVED = 'approved'
const METER_READING_BILLING_STATUS_DECLINED = 'declined'
const METER_READING_BILLING_STATUSES = [
    METER_READING_BILLING_STATUS_APPROVED,
    METER_READING_BILLING_STATUS_DECLINED,
]

const EXPORT_METER_READINGS_MONTHS_LIMIT = 2
const RESTRICTION_END_DAY_DEFAULT = 31

module.exports = {
    EXPORT_METER_READINGS_MONTHS_LIMIT,
    ...
    EXTERNAL_INTEGRATION_READING_SOURCE_ID,
    DAY_SELECT_OPTIONS,
    ...
    PROPERTY_METER_READING_MAX_VALUES_COUNT,
    METER_READING_BILLING_STATUS_APPROVED,
    METER_READING_BILLING_STATUS_DECLINED,
    METER_READING_BILLING_STATUSES,
    RESTRICTION_END_DAY_DEFAULT,
}
