...
export const MeterReportingPeriodForm: React.FC<IMeterReportingPeriodForm> = ({ mode, reportingPeriodRecord, action }) => {
    ...
    const StartLabel = intl.formatMessage({ id: 'meter.reportingPeriod.create.start' })
    const FinishLabel = intl.formatMessage({ id: 'meter.reportingPeriod.create.finish' })
    const IncorrectPeriodLabel = intl.formatMessage({ id: 'meter.reportingPeriod.create.incorrectPeriod' })
    const OrganizationLabel = intl.formatMessage({ id: 'meter.reportingPeriod.create.organizationPeriod' })
    const OrganizationTooltipMessage = intl.formatMessage({ id: 'meter.reportingPeriod.create.organizationTooltip' })
    const DescriptionMessage = intl.formatMessage({ id: 'meter.reportingPeriod.create.descriptionMessage' })
    const InputPostfixMessage = intl.formatMessage({ id: 'meter.reportingPeriod.create.inputPostfix' })
