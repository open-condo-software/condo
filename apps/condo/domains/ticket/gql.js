...
const TICKET_FILTER_TEMPLATE_FIELDS = `{ name employee { id } filters { number, createdAt, status, details, property, address, division, clientName, executor, assignee, executorName, assigneeName, attributes, source, sectionName, floorName, unitName, placeClassifier, categoryClassifier, clientPhone, author } ${COMMON_FIELDS} }`
