const { RU_LOCALE, EN_LOCALE, ES_LOCALE, TR_LOCALE } = require('@condo/domains/common/constants/locale')
const STATUS_IDS = {
...
const COUNTRY_RELATED_STATUS_TRANSITIONS = {
    ...
    [TR_LOCALE]: DEFAULT_STATUS_TRANSITIONS,
}
...
const TERMINAL_TICKET_STATUS_IDS = [STATUS_IDS.CLOSED, STATUS_IDS.DECLINED]
