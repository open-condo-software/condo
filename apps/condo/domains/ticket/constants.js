...
const OMIT_TICKET_CHANGE_TRACKABLE_FIELDS = ['v', 'dv', 'sender', 'categoryClassifier', 'placeClassifier', 'problemClassifier', 'createdAt', 'completedAt', 'lastCommentAt', 'createdBy', 'updatedAt', 'updatedBy', 'statusUpdatedAt', 'lastResidentCommentAt', 'search', 'searchFingerprint']
