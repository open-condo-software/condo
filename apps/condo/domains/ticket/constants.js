...
const OMIT_TICKET_CHANGE_TRACKABLE_FIELDS = ['v', 'dv', 'sender', 'categoryClassifier', 'isAutoClassified', 'placeClassifier', 'problemClassifier', 'createdAt', 'completedAt', 'lastCommentAt', 'createdBy', 'updatedAt', 'updatedBy', 'statusUpdatedAt', 'lastResidentCommentAt']
