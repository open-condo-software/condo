...
const OMIT_TICKET_CHANGE_TRACKABLE_FIELDS = [...OMIT_COMMON_TRACKABLE_FIELDS, 'categoryClassifier', 'isAutoClassified', 'placeClassifier', 'problemClassifier', 'completedAt', 'isCompletedAfterDeadline', 'lastCommentAt', 'statusUpdatedAt', 'lastResidentCommentAt', 'lastCommentWithResidentTypeAt', 'lastCommentWithOrganizationTypeAt', 'lastCommentWithResidentTypeCreatedByUserType', 'number', 'order', 'qualityControlUpdatedAt', 'deletedAt', 'qualityControlUpdatedBy', 'feedbackUpdatedAt']
