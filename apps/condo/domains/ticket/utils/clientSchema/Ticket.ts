...
export interface ITicketFormState {
    ...
    lastEmployeeAnsweredToResidentAt?: string
    assignee?: string
    operator?: string
    client?: string
    contact?: string
