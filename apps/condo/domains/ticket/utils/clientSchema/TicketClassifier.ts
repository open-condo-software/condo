...
import { TicketClassifier, TicketClassifierUpdateInput, QueryAllTicketClassifiersArgs, TicketClassifierWhereInput } from '@app/condo/schema'
...
const {
    ...
    useUpdate,
    useDelete,
} = generateReactHooks<TicketClassifier, TicketClassifierUpdateInput, ITicketClassifierFormState, ITicketClassifierUIState, QueryAllTicketClassifiersArgs>(TicketClassifierGQL, { convertToGQLInput, convertToUIState })
