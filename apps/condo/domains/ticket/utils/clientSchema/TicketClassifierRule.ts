...
const FIELDS = ['id', 'deletedAt', 'createdAt', 'updatedAt', 'createdBy', 'updatedBy', 'organization', 'place', 'category', 'description']
const RELATIONS = ['organization', 'place', 'category', 'description']
...
export type ITicketClassifierRuleWhereInput = Pick<TicketClassifierRuleWhereInput, 'organization' | 'organization_is_null' | 'id' | 'place' | 'category' | 'description'>
