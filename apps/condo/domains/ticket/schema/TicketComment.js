...
const TicketComment = new GQLListSchema('TicketComment', {
    schemaDoc: 'Represents a text comment attached to a ticket.',
    fields: {
        type: {
            schemaDoc: 'Comment visibility (internal for the organization or shared with a resident).',
            isRequired: true,
            type: 'Select',
            dataType: 'string',
        ...
        ticket: {
            schemaDoc: 'Ticket to which the comment belongs.',
            type: 'Relationship',
            ref: 'Ticket',
            isRequired: true,
        ...
        content: {
            schemaDoc: 'Plain text of the comment.',
            type: 'Text',
            hooks: {
