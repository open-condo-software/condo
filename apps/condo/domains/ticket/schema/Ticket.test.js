...
describe('Ticket', () => {
    test('user: create Ticket', async () => {
        ...
        expect(obj.locationClassifier).toEqual(expect.objectContaining({ id: attrs.locationClassifier.connect.id }))
        expect(obj.categoryClassifier).toEqual(expect.objectContaining({ id: attrs.categoryClassifier.connect.id }))
        expect(obj.subjectClassifier).toEqual(expect.objectContaining({ id: attrs.subjectClassifier.connect.id }))
