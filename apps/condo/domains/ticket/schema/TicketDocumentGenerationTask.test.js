    ...
    describe('Accesses', () => {
        describe('Admin', () => {
            ...
            test('can read any task', async () => {
                const tasks = await TicketDocumentGenerationTask.getAll(admin, {
                    id: task.id,
                })
        ...
        describe('Support', () => {
            ...
            test('cannot read any task', async () => {
                const tasks = await TicketDocumentGenerationTask.getAll(support, {
                    id: task.id,
                })
        ...
        describe('Staff', () => {
            ...
            test('can read its task', async () => {
                const tasks = await TicketDocumentGenerationTask.getAll(staff, {
                    id: task.id,
                })
                expect(tasks).toHaveLength(1)
                expect(tasks[0]).toHaveProperty('id', task.id)
        ...
        describe('Resident', () => {
            ...
            test('cannot read', async () => {
                await expectToThrowAccessDeniedErrorToObjects(async () => {
                    await TicketDocumentGenerationTask.getAll(resident, {
                        id: task.id,
                    })
                })
            })
        ...
        describe('Service user', () => {
            ...
            test('cannot read', async () => {
                await expectToThrowAccessDeniedErrorToObjects(async () => {
                    await TicketDocumentGenerationTask.getAll(serviceUser, {
                        id: task.id,
                    })
                })
            })
        ...
        describe('Anonymous', () => {
            ...
            test('cannot read', async () => {
                await expectToThrowAuthenticationErrorToObjects(async () => {
                    await TicketDocumentGenerationTask.getAll(anonymous, {
                        id: task.id,
                    })
                })
            })
