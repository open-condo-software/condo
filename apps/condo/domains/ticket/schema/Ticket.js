...
const { createTicketChange, ticketChangeDisplayNameResolversForSingleRelations, relatedManyToManyResolvers } = require('@condo/domains/ticket/utils/serverSchema/TicketChange')
...
const Ticket = new GQLListSchema('Ticket', {
    ...
    hooks: {
        resolveInput: async ({ operation, listKey, context, resolvedData, existingItem }) => {
            ...
            await calculateDeadline(operation, resolvedData, existingItem)
