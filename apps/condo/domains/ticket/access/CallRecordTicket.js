...
async function canReadCallRecordTickets ({ authentication: { item: user } }) {
...
async function canManageCallRecordTickets ({ authentication: { item: user }, originalInput, operation, itemId }) {
    if (!user) return throwAuthenticationError()
    if (user.deletedAt) return false
...
*/
module.exports = {
    canReadCallRecordTickets,
    canManageCallRecordTickets,
}
