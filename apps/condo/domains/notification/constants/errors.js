const { FIREBASE_CONFIG_ENV, RUSTORE_CONFIG_ENV, HCM_CONFIG_ENV, APPLE_CONFIG_ENV } = require('./constants')
...
const EMPTY_RUSTORE_CONFIG_ERROR = `Valid ${RUSTORE_CONFIG_ENV} should be provided within .helm (.env)`
