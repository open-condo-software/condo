const { FIREBASE_CONFIG_ENV, REDSTORE_CONFIG_ENV, HCM_CONFIG_ENV, APPLE_CONFIG_ENV } = require('./constants')
...
const EMPTY_REDSTORE_CONFIG_ERROR = `Valid ${REDSTORE_CONFIG_ENV} should be provided within .helm (.env)`
