...
const MESSAGE_TRANSPORTS = [SMS_TRANSPORT, EMAIL_TRANSPORT, WEBHOOK_TRANSPORT, PUSH_TRANSPORT]
...
const MESSAGE_DELIVERY_OPTIONS = {
    [TICKET_CREATED_TYPE]: {
        ...
        allowedTransports: [WEBHOOK_TRANSPORT, PUSH_TRANSPORT],
        defaultTransports: [WEBHOOK_TRANSPORT, PUSH_TRANSPORT],
