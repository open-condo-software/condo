...
const MESSAGE_META = {
    ...
    [CUSTOM_CONTENT_MESSAGE_TYPE]: {
        ...
        data: {
            ...
            marketingMessageId: { required: true },
        },
    },
}
...
const MARKETING_MESSAGE_CREATED_STATUS = 'created'
const MARKETING_MESSAGE_PROCESSING_STATUS = 'processing'
const MARKETING_MESSAGE_FAILED_STATUS = 'failed'
const MARKETING_MESSAGE_DONE_STATUS = 'done'
const MARKETING_MESSAGE_STATUSES = [MARKETING_MESSAGE_CREATED_STATUS, MARKETING_MESSAGE_PROCESSING_STATUS, MARKETING_MESSAGE_FAILED_STATUS, MARKETING_MESSAGE_DONE_STATUS]
// TODO(DOMA-4034) For safety sake User schema skips phone/emails in request results, so sms/email could hot be sent yet
const MARKETING_MESSAGE_TRANSPORT_TYPES = [/*SMS_TRANSPORT, EMAIL_TRANSPORT, */PUSH_TRANSPORT]
