...
const PUSH_TRANSPORT_RUSTORE = 'rustore'
const PUSH_TRANSPORT_APPLE = 'apple'
const PUSH_TRANSPORT_HUAWEI = 'huawei'
const PUSH_TRANSPORT_TYPES = [PUSH_TRANSPORT_FIREBASE, PUSH_TRANSPORT_APPLE, PUSH_TRANSPORT_HUAWEI, PUSH_TRANSPORT_RUSTORE]
...
const RUSTORE_CONFIG_ENV = 'RUSTORE_CONFIG_JSON'
const RUSTORE_CONFIG_TEST_PUSHTOKEN_ENV = 'RUSTORE_PUSH_TOKEN_TEST'
