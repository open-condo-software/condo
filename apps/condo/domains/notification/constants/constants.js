...
const REGION_MESSENGER_TRANSPORT = 'regionMessenger'
const PUSH_TRANSPORT = 'push'
const MESSAGE_TRANSPORTS = [SMS_TRANSPORT, EMAIL_TRANSPORT, TELEGRAM_TRANSPORT, REGION_MESSENGER_TRANSPORT, PUSH_TRANSPORT]
...
const PUSH_TRANSPORT_WEBHOOK = 'webhook'
const PUSH_TRANSPORT_ONESIGNAL = 'onesignal'
const PUSH_TRANSPORT_TYPES = [PUSH_TRANSPORT_FIREBASE, PUSH_TRANSPORT_APPLE, PUSH_TRANSPORT_HUAWEI, PUSH_TRANSPORT_REDSTORE, PUSH_TRANSPORT_WEBHOOK, PUSH_TRANSPORT_ONESIGNAL]
const PUSH_FAKE_TOKEN_SUCCESS = 'PUSH_FAKE_TOKEN_SUCCESS'
const PUSH_FAKE_TOKEN_FAIL = 'PUSH_FAKE_TOKEN_FAIL'

const REMOTE_CLIENT_GROUP_UNGROUPED = 'UNGROUPED'
...
const WEBHOOK_CONFIG_ENV = 'WEBHOOK_CONFIG_JSON'

const ONESIGNAL_CONFIG_ENV = 'ONESIGNAL_CONFIG_JSON'
...
const SYNC_REMOTE_CLIENT_TOKENS_RESET_WINDOW_SEC = 24 * 60 * 60
const MAX_SYNC_REMOTE_CLIENT_TOKENS_RESET_BY_WINDOW_SEC = 100 // NOTE(YEgorLu): 185 is max I saw
...
const MESSAGE_DELIVERY_OPTIONS = {
    [TICKET_CREATED_TYPE]: {
        ...
        allowedTransports: [TELEGRAM_TRANSPORT, REGION_MESSENGER_TRANSPORT, PUSH_TRANSPORT],
        defaultTransports: [TELEGRAM_TRANSPORT, REGION_MESSENGER_TRANSPORT, PUSH_TRANSPORT],
