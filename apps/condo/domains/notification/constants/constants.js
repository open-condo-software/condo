...
const PHONE_BY_USER_ID = 'phone_by_user_id'
const PUSH_VIA_REMOTE_CLIENT = 'rc'
const MESSAGE_BATCH_SENDING_FLOW = [SMS_TRANSPORT, EMAIL_TRANSPORT, TELEGRAM_TRANSPORT, PUSH_TRANSPORT, PHONE_BY_USER_ID, PUSH_VIA_REMOTE_CLIENT]
...
module.exports = {
    ...
    SEND_DAILY_STATISTICS_MESSAGE_TYPE,
    MESSAGE_BATCH_SENDING_FLOW,
    PHONE_BY_USER_ID,
    PUSH_VIA_REMOTE_CLIENT,
}
