...
const access = require('@condo/domains/notification/access/BlackList')
const { MESSAGE_TYPES } = require('@condo/domains/notification/constants/constants')

const BlackList = new GQLListSchema('BlackList', {
    ...
    access: {
        read: access.canReadBlackLists,
        create: access.canManageBlackLists,
        update: access.canManageBlackLists,
        delete: false,
        auth: true,
    },
})
