...
const access = require('@condo/domains/notification/access/MessageAppBlackList')
...
const MessageAppBlackList = new GQLListSchema('MessageAppBlackList', {
    ...
    fields: {
        app: {
            schemaDoc: 'the app we want to block from sending messages to (null - all organizations)',
            type: Relationship,
            ref: 'B2CApp',
