...
describe('Message', () => {
    test('user: create Message', async () => {
        ...
        const [obj, attrs] = await createTestMessage(client)  // TODO(codegen): write 'user: create Message' test
    ...
    test('anonymous: create Message', async () => {
        ...
        try {
            await createTestMessage(client)  // TODO(codegen): check the 'anonymous: create Message' test!
        } catch (e) {
    ...
    test('user: read Message', async () => {
        ...
        const [obj, attrs] = await createTestMessage(admin)  // TODO(codegen): check create function!

        const client = await makeClient()  // TODO(codegen): use truly useful client!
        const objs = await Message.getAll(client, {}, { sortBy: ['updatedAt_DESC'] })

        // TODO(codegen): check 'user: read Message' test!
    ...
    test('user: update Message', async () => {
        const admin = await makeLoggedInAdminClient()
        const [objCreated] = await createTestMessage(admin)  // TODO(codegen): check create function!

        const client = await makeClient()  // TODO(codegen): use truly useful client!
        const payload = {}  // TODO(codegen): change the 'user: update Message' payload
        const [objUpdated, attrs] = await updateTestMessage(client, objCreated.id, payload)

        // TODO(codegen): white checks for 'user: update Message' test
    ...
    test('anonymous: update Message', async () => {
        ...
        const client = await makeClient()
        const payload = {}  // TODO(codegen): change the 'anonymous: update Message' payload
        try {
    ...
    test('user: delete Message', async () => {
        ...
        const client = await makeClient()  // TODO(codegen): use truly useful client!
        try {
            // TODO(codegen): check 'user: delete Message' test!
    ...
    test('anonymous: delete Message', async () => {
        ...
        const client = await makeClient()
        try {
            // TODO(codegen): check 'anonymous: delete Message' test!
            await Message.delete(client, objCreated.id)
        } catch (e) {
            expect(e.errors[0]).toMatchObject({
                'message': 'You do not have access to this resource',
