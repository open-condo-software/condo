...
const MESSAGE_FIELDS = `{ organization { id } user { id email phone } remoteClient { id } email emailFrom phone defaultContent { content } lang type meta status processingMeta sentAt deliveredAt readAt uniqKey ${COMMON_FIELDS} }`
...
const REMOTE_CLIENT_PUSH_TOKEN_FIELDS = `{ id remoteClient ${REMOTE_CLIENT_FIELDS} provider isVoIP isPush ${COMMON_FIELDS} }`
