...
`
const SERVICE_CONSUMER_FIELDS = `{ residentBillingAccount { id } paymentCategory resident { id } billingAccount { id } accountNumber ${COMMON_FIELDS} organization { id name tin } residentAcquiringIntegrationContext { id integration } }`
