...
const RESIDENT_FIELDS = `{ user { id name } organization { id } residentOrganization { id name } property { id } residentProperty { id name } billingAccount { id } address addressMeta unitName ${COMMON_FIELDS} }`
