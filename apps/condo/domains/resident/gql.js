...
const FIND_ORGANIZATIONS_BY_ADDRESS_QUERY = gql`
    query findOrganizationsByAddress ($data: FindOrganizationsByAddressInput!) {
        result: findOrganizationsByAddress(data: $data) { organization { id name tin type } receipt { number category balance routingNumber bankAccountNumber } meter { number resource } }
    }
`
