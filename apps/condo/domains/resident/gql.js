...
`
const SERVICE_CONSUMER_FIELDS = `{ resident { id } billingAccount { id } accountNumber ${COMMON_FIELDS} paymentCategory, residentOrganization { id name tin }, residentBillingAccount { id } }`
