...
const RESIDENT_FIELDS = `{ user { id name } organization { id } residentOrganization { id name } property { id } residentProperty { id name address } address addressMeta { ${ADDRESS_META_SUBFIELDS_QUERY_LIST} } unitName ${COMMON_FIELDS} organizationFeatures { hasBillingData } paymentCategories { categoryName billingName acquiringName } }`
