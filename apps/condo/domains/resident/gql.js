...
`
const SERVICE_CONSUMER_FIELDS = `{ residentBillingAccount { id } residentAcquiringIntegrationContext { id integration { id hostUrl } } paymentCategory resident { id user { id locale } organization { id } unitType unitName deletedAt address property { id } } billingAccount { id number } billingIntegrationContext { id lastReport } accountNumber ${COMMON_FIELDS} organization { id name tin country } isDiscovered }`
