...
const REDIS_LAST_DATE_KEY = 'LAST_SEND_BILLING_RECEIPT_NOTIFICATION_CREATED_AT' // old redis key for last sync date
const REDIS_LAST_DATE_KEY_PREFIX = 'LAST_SEND_BILLING_RECEIPT_NOTIFICATION_CREATED_AT:' // new redis key prefix for last sync date
const BILLING_RECEIPTS_NOTIFIED_USERS_PREFIX = 'BILLING_RECEIPTS_NOTIFIED_USERS:' // redis key prefix for last sync date of every user
const USER_BILLING_RECEIPT_NOTIFICATION_PERIOD_IN_SEC = 24 * 60 * 60 // 1 day in seconds
...
module.exports = {
    ...
    REDIS_LAST_DATE_KEY,
    REDIS_LAST_DATE_KEY_PREFIX,
    BILLING_RECEIPTS_NOTIFIED_USERS_PREFIX,
    ...
    USER_BILLING_RECEIPT_NOTIFICATION_PERIOD_IN_SEC,
}
