            ...
            if (operation === 'create') {
                if (resident) {
                    return addValidationError(
                        'Cannot create resident, because another resident with the same provided set of "property", "unitName"',
                    )
                }
            } else if (operation === 'update') {
                if (resident && resident.id !== existingItem.id) {
                    return addValidationError(
                        'Cannot update resident, because another resident already exists with the same provided set of "property", "unitName"',
                    )
                }
            }
        },
