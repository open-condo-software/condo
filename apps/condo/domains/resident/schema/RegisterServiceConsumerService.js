    ...
    mutations: [
        ...
        },
        {
            doc: {
                ...
                description: 'To be successfully created with accountNumber the organization should at least have billingAccount with same data or Meter with same data',
                errors: ERRORS,
            },
            access: access.canRegisterServiceConsumer,
            ...
            resolver: async (parent, args, context = {}) => {
                ...
                let accountNumber
                if (!isNil(accountNumberUserInput)) {
                    accountNumber = (accountNumberUserInput || '').trim()
                ...
                if (accountNumber) {
                    existingConsumerQuery.accountNumber_i = accountNumber
                } else {
                    existingConsumerQuery.accountNumber = null
                }
                const [existingServiceConsumer] = await find('ServiceConsumer', existingConsumerQuery)
                if (existingServiceConsumer) {
                ...
                if (!accountNumber) {
                    ...
                    return await getById('ServiceConsumer', consumer.id)
                }
