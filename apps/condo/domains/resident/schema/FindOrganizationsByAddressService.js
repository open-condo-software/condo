...
const FindOrganizationsByAddressService = new GQLCustomSchema('FindOrganizationsByAddressService', {
    types: [
        ...
        {
            access: true,
            type: 'type FindOrganizationByAddressAccountType { number: String!, category: ID!, balance: String, routingNumber: String!, bankAccountNumber: String! }',
        },
        {
            access: true,
            type: 'type FindOrganizationByAddressOutput { organization: FindOrganizationByAddressOrganizationType!, account: FindOrganizationByAddressAccountType, hasMeters: Boolean!, hasBillingData: Boolean! }',
        },
    ],
