...
const { set, get, filter, flatMap, map, omit, pick, uniq } = require('lodash')
...
const { PropertyForDiscoverServiceConsumersService } = require('@condo/domains/property/utils/serverSchema')
    ...
    mutations: [
        {
            ...
            resolver: async (parent, args, context) => {
                ...
                await loadListByChunks({
                    context,
                    list: PropertyForDiscoverServiceConsumersService,
                    chunkSize: 50,
                    where: {
                        deletedAt: null,
