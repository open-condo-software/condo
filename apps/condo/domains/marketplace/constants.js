...
const ERROR_B2B_INVOICE_WITHOUT_PAYER_ORGANIZATION = 'B2B_INVOICE_WITHOUT_PAYER_ORGANIZATION'
const ERROR_B2B_INVOICE_SAME_ORGANIZATION = 'B2B_INVOICE_SAME_ORGANIZATION'
const ERROR_B2B_INVOICE_WITH_B2C_FIELDS = 'B2B_INVOICE_WITH_B2C_FIELDS'
const ERROR_B2C_INVOICE_WITH_B2B_FIELDS = 'B2C_INVOICE_WITH_B2B_FIELDS'
...
const B2C_INVOICE_FIELDS = ['property', 'unitType', 'unitName', 'ticket', 'contact', 'client', 'clientName', 'clientPhone']
const B2B_INVOICE_FIELDS = ['payerOrganization']
