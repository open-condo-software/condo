...
let dummyOrganization, dummyAcquiringIntegration, dummyAcquiringIntegrationContext
...
describe('Invoice', () => {
    beforeAll(async () => {
        ...
        [dummyAcquiringIntegrationContext] = await createTestAcquiringIntegrationContext(adminClient, dummyOrganization, dummyAcquiringIntegration, {
