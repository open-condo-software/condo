import { useGetAvailableSubscriptionPlansQuery, GetAvailableSubscriptionPlansQueryResult, useGetGlobalB2BAppsByIdsQuery } from '@app/condo/gql'
...
export const SubscriptionSettingsContent: React.FC = () => {
    ...
    const { data: b2bAppsData } = useGetGlobalB2BAppsByIdsQuery({
