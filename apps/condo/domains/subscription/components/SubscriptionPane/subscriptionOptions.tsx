...
export const getSubscriptionOptions = (
    intl: IntlShape,
    subscription: Pick<ServiceSubscription, 'type' | 'isTrial'>,
    ...
    const isTrial = get(subscription, 'isTrial')
        ...
        (
            <FocusContainer margin='0' key='sbbol'>
                <Row gutter={[0, 20]}>
                    ...
                    <Col span={24}>
                        {
                            subscription && !isTrial && type === 'sbbol'
                                ? (
                                    <Button
                                        key='submit'
                                        type='sberAction'
        ...
        (
            <FocusContainer margin='0' key='default' className={focusContainerClassNames}>
                <Row gutter={[0, 20]}>
                    ...
                    <Col span={24}>
                        {
                            subscription && !isTrial && type === 'default'
                                ? (
                                    <Button
                                        disabled
                                        type='sberPrimary'
