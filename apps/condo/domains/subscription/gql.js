...
const SUBSCRIPTION_CONTEXT_FIELDS = `{ organization { id } subscriptionPlan { id } subscriptionPlanPricingRule { id } invoice { id } startAt endAt isTrial settings { price paymentMethod { id } } daysRemaining ${COMMON_FIELDS} }`
