...
const SUBSCRIPTION_PLAN_FIELDS = `{ name description organizationType trialDays news marketplace support ai disabledB2BApps disabledB2CApps customization isHidden priority canBePromoted ${COMMON_FIELDS} }`
...
const SUBSCRIPTION_CONTEXT_FIELDS = `{ organization { id } subscriptionPlan { id } pricingRule { id name price currencyCode period } startAt endAt frozenPricingRule isTrial daysRemaining ${COMMON_FIELDS} }`
