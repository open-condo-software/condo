...
const SUBSCRIPTION_PLAN_FIELDS = `{ name description organizationType trialDays news marketplace support ai enanledB2BApps enabledB2CApps customization isHidden priority canBePromoted ${COMMON_FIELDS} }`
