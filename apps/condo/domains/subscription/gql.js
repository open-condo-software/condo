...
const SUBSCRIPTION_PLAN_FIELDS = `{ name description organizationType trialDays news marketplace support ai passTickets customization isHidden priority canBePromoted ${COMMON_FIELDS} }`
