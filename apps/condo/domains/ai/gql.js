...
const AISKILL_FIELDS = `{ name description displayName displayDescription content license compatibility metadata allowedTools locale meta isPublic image { id publicUrl } examples b2bApp { id name logo { id publicUrl } } scope organization { id } user { id } ${COMMON_FIELDS} }`
