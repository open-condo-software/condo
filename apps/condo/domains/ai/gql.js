...
const EXECUTION_AIFLOW_TASK_FIELDS = `{ flowType context cleanContext status result errorMessage error meta locale user { id } organization { id } modelName itemId sessionId ${COMMON_FIELDS} }`
const ExecutionAIFlowTask = generateGqlQueries('ExecutionAIFlowTask', EXECUTION_AIFLOW_TASK_FIELDS)

const EXECUTION_AIFLOW_TASK_FIELDS_FOR_USER = `{ flowType context status result errorMessage locale user { id } organization { id } modelName itemId sessionId ${COMMON_FIELDS} }`
