    ...
    describe('CRUD tests', () => {
        describe('create', () => {
            ...
            test('support can', async () => {
                ...
                const [obj, attrs] = await createTestBankCategory(client)  // TODO(codegen): write 'support: create BankCategory' test
            ...
            test('user can', async () => {
                ...
                const [obj, attrs] = await createTestBankCategory(client)  // TODO(codegen): write 'user: create BankCategory' test
            ...
            test('anonymous can\'t', async () => {
                ...
                await expectToThrowAuthenticationErrorToObj(async () => {
                    await createTestBankCategory(client)  // TODO(codegen): write 'anonymous: create BankCategory' test
                })
            })
        })
        ...
        describe('update', () => {
            ...
            test('support can', async () => {
                ...
                const [obj, attrs] = await updateTestBankCategory(client, objCreated.id)  // TODO(codegen): write 'support: update BankCategory' test
            ...
            test('user can', async () => {
                ...
                const client = await makeClientWithNewRegisteredAndLoggedInUser()  // TODO(codegen): create USER client!
                const [obj, attrs] = await updateTestBankCategory(client, objCreated.id)  // TODO(codegen): write 'user: update BankCategory' test
            ...
            test('anonymous can\'t', async () => {
                ...
                const client = await makeClient()
                await expectToThrowAuthenticationErrorToObj(async () => {
                    await updateTestBankCategory(client, objCreated.id)  // TODO(codegen): write 'anonymous: update BankCategory' test
                })
            })
        })
        ...
        describe('hard delete', () => {
            test('admin can\'t', async () => {
                ...
                await expectToThrowAccessDeniedErrorToObj(async () => {
                    await BankCategory.delete(admin, objCreated.id)  // TODO(codegen): write 'admin: delete BankCategory' test
                })
            })
            ...
            test('user can\'t', async () => {
                ...
                const client = await makeClientWithNewRegisteredAndLoggedInUser()  // TODO(codegen): create USER client!
                await expectToThrowAccessDeniedErrorToObj(async () => {
                    await BankCategory.delete(client, objCreated.id)  // TODO(codegen): write 'user: delete BankCategory' test
                })
            })
            ...
            test('anonymous can\'t', async () => {
                ...
                const client = await makeClient()
                await expectToThrowAuthenticationErrorToObj(async () => {
                    await BankCategory.delete(client, objCreated.id)  // TODO(codegen): write 'anonymous: delete BankCategory' test
                })
            })
        })
