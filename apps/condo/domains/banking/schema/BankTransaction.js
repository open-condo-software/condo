        ...
        constraints: [
            {
                ...
                fields: ['organization', 'account', 'contractorAccount', 'importRemoteSystem', 'importId'],
                condition: 'Q(deletedAt__isnull=True)',
                name: 'Bank_transaction_unique_organization_account_contractorAccount_importRemoteSystem_importId',
            },
        ],
    },
})
