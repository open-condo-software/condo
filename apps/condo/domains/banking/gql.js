...
const BANK_CONTRACTOR_ACCOUNT_FIELDS = `{ name organization { id } costItem { id } tin country routingNumber number currencyCode importId territoryCode bankName meta tinMeta routingNumberMeta ${COMMON_FIELDS} }`
