...
const { createTestPropertyScopeProperty, updateTestPropertyScopeProperty, createTestPropertyScope, PropertyScopeProperty } = require('@condo/domains/scope/utils/testSchema')
...
describe('PropertyScopeProperty', () => {
    describe('accesses', () => {
        describe('admin', () => {
            describe('can create PropertyScopeProperty', async () => {
            ...
            describe('can update PropertyScopeProperty', async () => {
                const admin = await makeLoggedInAdminClient()
                ...
                const [updatedPropertyScope] = await updateTestPropertyScopeProperty(admin, propertyScopeProperty.id, {})
    ...
    describe('logic', () => {
        it('soft delete related PropertyScopeProperties after soft delete property', async () => {
            const admin = await makeLoggedInAdminClient()
            ...
            await waitFor(async () => {
                const readPropertyScopeProperty = await PropertyScopeProperty.getOne(admin, {
                    id: propertyScopeProperty.id,
                    deletedAt_not: null,
                })
