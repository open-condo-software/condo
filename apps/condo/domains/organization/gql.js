...
const ORGANIZATION_FIELDS = `{ country name type description avatar { publicUrl } meta tin features statusTransitions defaultEmployeeRoleStatusTransitions importId importRemoteSystem phone phoneNumberPrefix isApproved subscription { paymentsEndAt metersEndAt ticketsEndAt newsEndAt marketplaceEndAt supportEndAt aiEndAt customizationEndAt propertiesEndAt analyticsEndAt enabledB2BApps enabledB2CApps daysRemaining activeSubscriptionContextId activeSubscriptionEndAt } ${COMMON_FIELDS} }`
