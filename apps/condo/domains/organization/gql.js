...
const ORGANIZATION_EMPLOYEE_ROLE_FIELDS = '{ organization { id } name description statusTransitions canManageOrganization canManageEmployees canManageRoles canManageTicketHints canManageIntegrations canReadBillingReceipts canReadPayments canManageProperties canManageTickets canManageContacts canManageTicketComments canManageDivisions canShareTickets canBeAssignedAsResponsible canBeAssignedAsExecutor canManageMeters canManageMeterReadings canReadEntitiesOnlyInScopeOfDivision id dv sender { dv fingerprint } v createdBy { id name } updatedBy { id name } createdAt updatedAt }'
