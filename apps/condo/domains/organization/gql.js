...
const ORGANIZATION_FIELDS = `{ country name type description avatar { publicUrl } meta tin features statusTransitions defaultEmployeeRoleStatusTransitions importId importRemoteSystem phone phoneNumberPrefix isApproved subscription { id subscriptionPlan { id name priority news marketplace support ai passTickets } startAt endAt isTrial daysRemaining } ${COMMON_FIELDS} }`
