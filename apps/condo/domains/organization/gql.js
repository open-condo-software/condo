...
const ORGANIZATION_FIELDS = `{ country name type description avatar { publicUrl } meta tin features statusTransitions defaultEmployeeRoleStatusTransitions importId importRemoteSystem phone phoneNumberPrefix isApproved subscription { payments meters tickets news marketplace support ai customization disabledB2BApps disabledB2CApps } ${COMMON_FIELDS} }`
