...
import { OrganizationEmployee, REGISTER_NEW_ORGANIZATION_MUTATION, INVITE_NEW_ORGANIZATION_EMPLOYEE_MUTATION, Organization } from '@condo/domains/organization/gql'
...
module.exports = {
    ...
    Organization: genReactHooks(Organization, { convertGQLItemToUIState, convertUIStateToGQLItem }),
