...
const ORGANIZATION_SUBSCRIPTION_FIELD = {
    ...
    graphQLReturnFragment: '{ id organization { id } subscriptionPlan { id name trialDays priority news marketplace support ai disabledB2BApps disabledB2CApps canBePromoted } startAt endAt isTrial daysRemaining }',
