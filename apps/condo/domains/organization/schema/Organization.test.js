...
describe('Organization', () => {
    ...
    test('user: can read not his own organizations only if he has ServiceConsumer linked to this organization', async () => {
        ...
        const noConsumerOrganizations = await Organization.getAll(userClient, {}, { raw: true })
        expect(noConsumerOrganizations.data.objs).toHaveLength(1)
        ...
        const consumerOrganizations = await Organization.getAll(userClient, {}, { raw: true })
        expect(consumerOrganizations.data.objs).toHaveLength(2)
    })
})
