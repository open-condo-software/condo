...
const CONTACT_FIELDS = `{ organization { id name phone phoneNumberPrefix } property { id address addressMeta { ${ADDRESS_META_SUBFIELDS_QUERY_LIST} } } name phone unitName unitType email role { id name } quota isVerified ${COMMON_FIELDS} }`
