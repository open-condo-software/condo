...
describe('sendDailyStatistics', () => {
    ...
    describe('"sendDailyMessageToUserSafely" should correct work', () => {
        test('should send only one message to user and message should have meta with statistics data', async () => {
            ...
            await sendDailyMessageToUserSafely(context, null, { ...administratorClient.user, email: administratorClient.userAttrs.email }, currentDate, null)
            await sendDailyMessageToUserSafely(context, null, { ...administratorClient.user, email: administratorClient.userAttrs.email }, currentDate, null)
            ...
            expect(message).toEqual(expect.objectContaining({
                ...
                meta: expect.objectContaining({
                    ...
                    data: {
                        ...
                        incidents: {
                            water: `${getDate(actualWaterIncidentSoonForOneProperty)} - ${administratorClient.property.address}\n${getDate(actualWaterIncidentSoonForAllProperties)} - ${i18n('notification.messages.SEND_DAILY_STATISTICS_MESSAGE_TYPE.email.allProperties', { locale: administratorClient.user.locale })}`,
                        },
                    },
