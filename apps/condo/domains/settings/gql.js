...
const MOBILE_FEATURE_CONFIG_FIELDS = `{ organization { id } commonPhone onlyGreaterThanPreviousMeterReadingIsEnabled ticketSubmittingIsDisabled ticketSubmittingForServiceProviderOrgIsDisabled meta ${COMMON_FIELDS} }`
