...
const { ACCESS_RIGHT_SET_NOT_FOR_CONNECTED_B2B_APP, ACCESS_RIGHT_SET_MINIAPP_SCOPE_RIGHT_SET_REQUIRED, ACCESS_RIGHT_SET_MINIAPP_SCOPE_TYPE } = require('@condo/domains/miniapp/constants')
...
const ERRORS = {
    ...
    ACCESS_RIGHT_SET_INVALID_TYPE: {
        ...
        message: '"accessRightSet" should have field "type" with value "miniapp"',
    },
}
    ...
    hooks: {
        validateInput: async ({ resolvedData, context, existingItem }) => {
            ...
            if (accessRightSetId && shouldCheckAccessRight) {
                ...
                if (accessRightSet.type !== ACCESS_RIGHT_SET_MINIAPP_SCOPE_TYPE) {
