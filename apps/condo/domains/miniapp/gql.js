...
const B2C_APP_FIELDS = `{ name isHidden colorSchema { main secondary } currentBuild { id } additionalDomains domains { mapping { from to } } isSubscriptionRequired ${COMMON_FIELDS} }`
