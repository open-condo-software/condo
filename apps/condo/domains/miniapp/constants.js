...
const RESTRICT_APP_CHANGE_ERROR = '[build:app] The "app" field can only be updated to null to trigger a soft-delete operation. If you want to relink build to another app, you must create a separate build for it'
