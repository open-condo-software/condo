...
const ACCESS_TOKEN_MINIAPP_SCOPE_TYPE = 'miniapp'
const ACCESS_TOKEN_TOKEN_SCOPE_TYPE = 'token'

const ACCESS_TOKEN_SCOPE_TYPES = [
    ACCESS_TOKEN_MINIAPP_SCOPE_TYPE,
    ACCESS_TOKEN_TOKEN_SCOPE_TYPE,
]

const ACCESS_TOKEN_MAX_ITEMS_MINIAPP_SCOPE_TYPE = 1
const ACCESS_TOKEN_MAX_ITEMS_TOKEN_SCOPE_TYPE = 10

const ACCESS_TOKEN_MAX_ITEMS_FOR_SCOPE = {
    [ACCESS_TOKEN_MINIAPP_SCOPE_TYPE]: ACCESS_TOKEN_MAX_ITEMS_MINIAPP_SCOPE_TYPE,
    [ACCESS_TOKEN_TOKEN_SCOPE_TYPE]: ACCESS_TOKEN_MAX_ITEMS_TOKEN_SCOPE_TYPE,
}
...
module.exports = {
    ...
    ACCESS_TOKEN_MINIAPP_SCOPE_TYPE,
    ACCESS_TOKEN_TOKEN_SCOPE_TYPE,
    ACCESS_TOKEN_SCOPE_TYPES,

    ACCESS_TOKEN_MAX_ITEMS_MINIAPP_SCOPE_TYPE,
    ACCESS_TOKEN_MAX_ITEMS_TOKEN_SCOPE_TYPE,
    ACCESS_TOKEN_MAX_ITEMS_FOR_SCOPE,
