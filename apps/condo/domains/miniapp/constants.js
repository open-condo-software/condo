...
const ACCESS_RIGHT_SET_MINIAPP_SCOPE_RIGHT_SET_REQUIRED = 'ACCESS_RIGHT_SET_MINIAPP_SCOPE_RIGHT_SET_REQUIRED'
...
const ACCESS_TOKEN_TTL_TOO_BIG = 'ACCESS_TOKEN_TTL_TOO_BIG'
...
const ACCESS_RIGHT_SET_MINIAPP_SCOPE_TYPE = 'miniapp'
const ACCESS_RIGHT_SET_TOKEN_SCOPE_TYPE = 'token'

const ACCESS_RIGHT_SET_SCOPE_TYPES = [
    ACCESS_RIGHT_SET_MINIAPP_SCOPE_TYPE,
    ACCESS_RIGHT_SET_TOKEN_SCOPE_TYPE,
]

const ACCESS_RIGHT_SET_MAX_ITEMS_MINIAPP_SCOPE_TYPE = 1
const ACCESS_RIGHT_SET_MAX_ITEMS_TOKEN_SCOPE_TYPE = 10

const ACCESS_RIGHT_SET_MAX_ITEMS_FOR_SCOPE = {
    [ACCESS_RIGHT_SET_MINIAPP_SCOPE_TYPE]: ACCESS_RIGHT_SET_MAX_ITEMS_MINIAPP_SCOPE_TYPE,
    [ACCESS_RIGHT_SET_TOKEN_SCOPE_TYPE]: ACCESS_RIGHT_SET_MAX_ITEMS_TOKEN_SCOPE_TYPE,
}
...
module.exports = {
    ...
    NAME_REQUIRED,
    ACCESS_RIGHT_SET_MINIAPP_SCOPE_RIGHT_SET_REQUIRED,
    ...
    ACCESS_RIGHT_SET_MINIAPP_SCOPE_TYPE,
    ACCESS_RIGHT_SET_TOKEN_SCOPE_TYPE,
    ACCESS_RIGHT_SET_SCOPE_TYPES,

    ACCESS_RIGHT_SET_MAX_ITEMS_MINIAPP_SCOPE_TYPE,
    ACCESS_RIGHT_SET_MAX_ITEMS_TOKEN_SCOPE_TYPE,
    ACCESS_RIGHT_SET_MAX_ITEMS_FOR_SCOPE,
