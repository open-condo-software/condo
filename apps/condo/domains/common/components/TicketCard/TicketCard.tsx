...
const TicketCard: React.FC<ITicketCardProps> = ({ organizationId, contactId, contactName, address, unitName }) => {
    const intl = useIntl()
    ...
    const MoreTicketsLeftMessage = intl.formatMessage(
        { id: 'MoreTicketsLeft' },
        {
                        ...
                        {loading ? (
                            ...
                            <>
                                {tickets.length > 0 ? (
                                    ...
                                    <Typography.Text style={{ fontSize: 16 }}>{NoTicketsOnAddressMessage}</Typography.Text>
                                )}
                                {tickets.map((ticket) => {
                                    return (
                                        <TicketOverview
