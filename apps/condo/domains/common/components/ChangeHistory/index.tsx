...
export const ChangeHistory = <ChangesType extends BaseChangesType> (props: ChangeHistoryInputType<ChangesType>): ChangeHistoryReturnType => {
    ...
    const { items, total, loading, title, useChangedFieldMessagesOf, labelSpan, HistoricalChange, dataCy } = props
    ...
    return items.length > 0 && (
        <Col span={24} style={CHANGE_HISTORY_COL_STYLE} data-cy={dataCy ?? undefined}>
