...
export type RequestHandler<Method extends AllRequestMethods> = (params: RequestParams<Method>, origin: string, source: Window, sourceId: string) => HandlerResult<Method> | Promise<HandlerResult<Method>>
