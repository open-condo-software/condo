...
const SberIconWithoutLabelSvg: React.FC<ISberIcon> = ({ width = 16, height = 16 }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 17 17">
            <path d="M15.003 3.274c.398.518.735 1.08 1.003 1.675l-7.63 5.658-3.189-2.011V6.177l3.189 2.011 6.627-4.914ZM1.935 8.425c0-.108.003-.216.008-.323L.01 8.006a8.432 8.432 0 0 0 2.443 6.376l1.371-1.379a6.472 6.472 0 0 1-1.889-4.578ZM8.376 1.946c.108 0 .215.004.322.009L8.795.01a8.323 8.323 0 0 0-6.342 2.458l1.371 1.379a6.38 6.38 0 0 1 4.552-1.901ZM8.376 14.905c-.108 0-.215 0-.322-.009l-.097 1.944a8.317 8.317 0 0 0 6.339-2.458l-1.368-1.378a6.411 6.411 0 0 1-4.552 1.901Z" fill="#fff"/>
            <path d="m12.009 3.076 1.628-1.207A8.31 8.31 0 0 0 8.375 0v1.946a6.38 6.38 0 0 1 3.633 1.13ZM16.752 8.425a8.493 8.493 0 0 0-.132-1.51l-1.803 1.337v.173a6.475 6.475 0 0 1-2.122 4.802l1.301 1.445a8.4 8.4 0 0 0 2.038-2.829 8.45 8.45 0 0 0 .718-3.418ZM8.375 14.904a6.407 6.407 0 0 1-4.774-2.134l-1.437 1.307a8.353 8.353 0 0 0 2.813 2.05 8.306 8.306 0 0 0 3.398.723ZM4.057 3.623l-1.3-1.446A8.44 8.44 0 0 0 0 8.425h1.935a6.492 6.492 0 0 1 2.122-4.802Z" fill="#fff"/>
        </svg>
    )
}
