...
export const SectionIcon: React.FC<IPropertyMapIcon> = ({ height = 25, width = 25 }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} fill="none">
        <path
            d="M6.8 10c-.442 0-.8.297-.8.664v3.672c0 .367.358.664.8.664.442 0 .8-.297.8-.664v-3.672c0-.367-.358-.664-.8-.664ZM15.2 10c-.442 0-.8.297-.8.664v3.672c0 .367.358.664.8.664.442 0 .8-.297.8-.664v-3.672c0-.367-.358-.664-.8-.664Z"
            fill="currentColor"
            stroke="currentColor"
            strokeWidth=".2"
        />
...
export const ParkingIcon: React.FC<IPropertyMapIcon> = ({ height = 25, width = 25 }) => (
    <svg width={width} height={height} fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path
            d="M10.736 5C12.536 5 14 6.565 14 8.49c0 1.923-1.464 3.488-3.264 3.488h-2.39v2.303c0 .397-.301.719-.673.719-.372 0-.673-.322-.673-.72V5.72c0-.398.301-.72.673-.72h3.063Zm0 1.439h-2.39v4.1h2.39c1.057 0 1.918-.92 1.918-2.05s-.86-2.05-1.918-2.05Z"
            fill="currentColor"
            stroke="currentColor"
            strokeWidth=".3"
        />
...
export const BasementIcon: React.FC<IPropertyMapIcon> = ({ height = 25, width = 25 }) => (
    <svg width={width} height={height} fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect x="1" y="1" width="20" height="20" rx="4" stroke="currentColor" strokeWidth="1.6" />
        <path
            d="M1 5.5h7a1 1 0 0 1 1 1v4M1.5 10.5H12a1 1 0 0 1 1 1v4M1 15.5h15a1 1 0 0 1 1 1v4"
            stroke="currentColor"
            strokeWidth="1.6"
        />
    </svg>
...
export const CeilIcon: React.FC<IPropertyMapIcon> = ({ height = 25, width = 25 }) => (
    <svg width={width} height={height} fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
            d="M1 9.083a4 4 0 0 1 1.706-3.277l6-4.2a4 4 0 0 1 4.588 0l6 4.2A4 4 0 0 1 21 9.083V16a4 4 0 0 1-4 4H5a4 4 0 0 1-4-4V9.083Z"
            stroke="currentColor"
            strokeWidth="1.7"
        />
