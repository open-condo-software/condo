...
const EXCEL_TEMPLATES_HEADERS = {
    [EXPORT_TYPE_PAYMENTS]: ['date', 'account', 'address', 'unitName', 'type', 'transaction', 'status', 'amount'],
    ...
    [EXPORT_TYPE_TICKETS]: [
        ...
        'organizationComments', 'residentComments', 'deadline', 'reviewValue', 'reviewComment', 'statusReopenedCounter',
    ],
