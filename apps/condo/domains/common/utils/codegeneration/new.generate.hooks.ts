...
type IRefetchType<GQLObject> = Promise<ApolloQueryResult<IUseObjectsQueryReturnType<GQLObject>>>
type IFetchMoreType<GQLObject, QueryVariables> = (variables: QueryVariables) => IRefetchType<GQLObject>
type IBasicUseQueryResult<GQLObject, QueryVariables> = {
    loading: boolean
    error?: string
    refetch: IRefetchType<GQLObject>
...
interface IGenerateHooksResult<GQLObject, GQLCreateInput, GQLUpdateInput, QueryVariables> {
    useNewCreate: (initialValues: Partial<GQLCreateInput>, onComplete?: IOnCompleteType<GQLObject>)
    => IUseCreateActionType<GQLObject, GQLCreateInput>
    useNewUpdate: (initialValues: Partial<GQLUpdateInput>, onComplete?: IOnCompleteType<GQLObject>)
    => IUseUpdateActionType<GQLObject, GQLUpdateInput>
    useNewSoftDelete: (onComplete?: IOnCompleteType<GQLObject>)
    => IUseSoftDeleteActionType<GQLObject>
    useNewObjects: (variables: QueryVariables, options?: QueryHookOptions<IUseObjectsQueryReturnType<GQLObject>, QueryVariables>)
    => IUseObjectsReturnType<GQLObject, QueryVariables>
    useNewObject: (variables: QueryVariables, options?: QueryHookOptions<IUseObjectsQueryReturnType<GQLObject>, QueryVariables>)
...
> (gql: IGQLType): IGenerateHooksResult<GQLObject, GQLCreateInput, GQLUpdateInput, QueryVariables> {
    ...
    function useObjects (variables: QueryVariables, options?: QueryHookOptions<IUseObjectsQueryReturnType<GQLObject>, QueryVariables>) {
        ...
        const typedRefetch: IRefetchType<GQLObject> = refetch
    ...
    return {
        useNewCreate: useCreate,
        useNewUpdate: useUpdate,
        useNewSoftDelete: useSoftDelete,
        useNewObjects: useObjects,
        useNewObject: useObject,
    }
}