...
const { GET_NEWS_SHARING_RECIPIENTS_COUNTERS_MUTATION } = require('@condo/domains/news/gql')
...
async function getNewsSharingRecipientsCountersByTestClient(client, b2bAppContext, extraAttrs = {}) {
    ...
    const { data, errors } = await client.mutate(GET_NEWS_SHARING_RECIPIENTS_COUNTERS_MUTATION, { data: attrs })
    throwIfError(data, errors)
    return [data.result, attrs]
}
