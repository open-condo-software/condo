...
const NEWS_ITEM_SHARING_FIELDS = `{ b2bAppContext { id app { newsSharingConfig { name customGetRecipientsCountersUrl } } } newsItem { id } sharingParams status statusMessage lastPostRequest ${COMMON_FIELDS} createdAt }`
const NewsItemSharing = generateGqlQueries('NewsItemSharing', NEWS_ITEM_SHARING_FIELDS)

const GET_NEWS_SHARING_RECIPIENTS_QUERY = gql`
...
module.exports = {
    ...
    NewsItemSharing,
    GET_NEWS_SHARING_RECIPIENTS_QUERY,
