...
const NEWS_ITEM_SCOPE_FIELDS = `{ newsItem { id organization { id } isPublished } property { id address addressMeta { ${ADDRESS_META_SUBFIELDS_TABLE_LIST} } } unitType unitName ${COMMON_FIELDS} }`
