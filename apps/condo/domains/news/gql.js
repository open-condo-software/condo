...
const NEWS_ITEM_FIELDS = `{ organization { id } number title body type validBefore postponeUntil sendAt sentAt isPublished publishedAt ${COMMON_FIELDS} compactScopes { count firstOnes { id unitType unitName property { address addressMeta { ${ADDRESS_META_SUBFIELDS_TABLE_LIST} } } } } }`
