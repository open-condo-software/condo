...
const processNewsItemScopes = (newsItemScopes: TNewsItemScopeNoInstance[]) => {
...
export const NewsItemSharingCustomRecipientCounter: React.FC<{ contextId: string, newsItemScopes: TNewsItemScopeNoInstance[] }> = ({ contextId, newsItemScopes }) => {
