...
const { makeLoggedInAdminClient, makeClient, UUID_RE, expectValuesOfCommonFields, catchErrorFrom,
...
const { STATUSES, ALLOWED_TRANSITIONS } = require('../constants/newsItemSharingStatuses')
