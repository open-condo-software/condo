...
const { makeLoggedInAdminClient, makeClient, setFeatureFlag, expectToThrowGQLError, catchErrorFrom, expectToThrowAuthenticationErrorToObj, expectToThrowAccessDeniedErrorToObjects, expectToThrowAuthenticationErrorToObjects } = require('@open-condo/keystone/test.utils')
...
describe('TourStep', () => {
    ...
    describe('Validation', () => {
        it('can not update TourStep type field', async () => {
            const [organization] = await registerNewOrganization(admin)
