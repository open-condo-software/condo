...
const BasePropertyForm: React.FC<IPropertyFormProps> = (props) => {
    ...
    const UnsupportedPropertyErrorMsg = intl.formatMessage({
        id: 'pages.condo.property.warning.modal.UnsupportedPropertyErrorMsg',
    })
                                    ...
                                    >
                                        <AddressSuggestionsSearchInput
                                            onSelect={(_, option) => {
                                                ...
                                                if (
                                                    address.data.settlement_type_full &&
                                                    !validSettlementTypes.includes(address.data.settlement_type_full)
                                                ) {
                                                    setAddressValidatorError(
                                                        UnsupportedPropertyErrorMsg.replace(
                                                            '{propertyType}',
                                                            address.data.settlement_type_full,
                                                        ),
                                                    )
