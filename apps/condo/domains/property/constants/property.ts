...
// "д" - "дом" or "к" - "корпус"
const validHouseTypes: AddressMetaField['data']['house_type_full'][] = [
    'дом',
    'корпус',
    'строение',
    'домовладение',
...
export { buildingEmptyMapJson, buildingMapJson, buildingAddressMetaJson, notValidBuildingMapJson, validHouseTypes }
