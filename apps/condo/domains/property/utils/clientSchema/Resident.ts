...
import { Resident as ResidentGQL } from '@condo/domains/property/gql'
import { Resident, ResidentUpdateInput, QueryAllResidentsArgs } from '../../../../schema'

const FIELDS = ['id', 'deletedAt', 'createdAt', 'updatedAt', 'createdBy', 'updatedBy', 'organization', 'property', 'contact', 'billingAccount', 'unitName', 'name', 'email', 'phone']
const RELATIONS = ['organization', 'property', 'contact', 'billingAccount']
