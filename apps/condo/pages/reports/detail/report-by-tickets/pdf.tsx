...
const PdfView = () => {
    ...
    const DefaultTickets = intl.formatMessage({ id: 'analytics.TicketAnalyticsPage.DefaultTickets' })
    const PaidTickets = intl.formatMessage({ id: 'analytics.TicketAnalyticsPage.PaidTickets' })
    const EmergencyTickets = intl.formatMessage({ id: 'analytics.TicketAnalyticsPage.EmergencyTickets' })
    const LoadingTip = intl.formatMessage({ id: 'analytics.TicketAnalyticsPage.PDF.LoadingTip' })
