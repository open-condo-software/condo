...
export type Contact = {
  ...
  /**  Property unit, on which issue(s) had been reported in ticket(s) by this person. It may be considered as a living place of this person in the future. A person can not report it's accommodation, so, this field is not required  */
  unitName?: Maybe<Scalars['String']>;
  /**  Contact email of this person  */
  email?: Maybe<Scalars['String']>;
  /**  Contact phone of this person in E.164 format without spaces  */
