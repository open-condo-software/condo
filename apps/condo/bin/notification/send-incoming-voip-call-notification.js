 ...
 *
 * Usage:
 *      yarn workspace @app/condo node ./bin/notification/send-incoming-voip-call-notification <USER_ID> <MINI_APP_ID> <CALL_ID>
 */
...
async function main () {
    ...
    await sendIncomingVoIPCallNotification({ userId, miniAppId, callId })
