...
export type GetFirstInvitationQueryVariables = Types.Exact<{
    userId: Types.Scalars['ID']['input']
}>


export type GetFirstInvitationQuery = { __typename?: 'Query', invitations?: Array<{ __typename?: 'OrganizationEmployee', id: string } | null> | null }
