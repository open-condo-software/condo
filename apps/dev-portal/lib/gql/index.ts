...
export type GetOidcClientInfoQueryVariables = Exact<{
    where: OidcClientWhereInput;
}>


export type GetOidcClientInfoQuery = { __typename?: 'Query', clients?: Array<{ __typename?: 'OIDCClient', id: string, clientId?: string | null, developmentRedirectUri?: string | null, productionRedirectUri?: string | null } | null> | null }
...
export type CreateOidcClientMutation = { __typename?: 'Mutation', client?: { __typename?: 'OIDCClient', clientSecret?: string | null } | null }

export type UpdateOidcClientSecretMutationVariables = Exact<{
    id: Scalars['ID']['input'];
    data?: InputMaybe<OidcClientUpdateInput>;
}>


export type UpdateOidcClientSecretMutation = { __typename?: 'Mutation', client?: { __typename?: 'OIDCClient', clientSecret?: string | null } | null }
...
export type UpdateOidcClientMutation = { __typename?: 'Mutation', client?: { __typename?: 'OIDCClient', id: string, developmentRedirectUri?: string | null, productionRedirectUri?: string | null } | null }
...
export const GetOidcClientInfoDocument = gql`
    query getOIDCClientInfo($where: OIDCClientWhereInput!) {
  clients: allOIDCClients(where: $where, first: 1) {
    id
    clientId
...
/**
 * __useGetOidcClientInfoQuery__
 *
 * To run a query within a React component, call `useGetOidcClientInfoQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetOidcClientInfoQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetOidcClientInfoQuery({
 *   variables: {
 *      where: // value for 'where'
 *   },
 * });
 */
export function useGetOidcClientInfoQuery (baseOptions: Apollo.QueryHookOptions<GetOidcClientInfoQuery, GetOidcClientInfoQueryVariables>) {
    const options = { ...defaultOptions, ...baseOptions }
    return Apollo.useQuery<GetOidcClientInfoQuery, GetOidcClientInfoQueryVariables>(GetOidcClientInfoDocument, options)
}
export function useGetOidcClientInfoLazyQuery (baseOptions?: Apollo.LazyQueryHookOptions<GetOidcClientInfoQuery, GetOidcClientInfoQueryVariables>) {
    const options = { ...defaultOptions, ...baseOptions }
    return Apollo.useLazyQuery<GetOidcClientInfoQuery, GetOidcClientInfoQueryVariables>(GetOidcClientInfoDocument, options)
}
export type GetOidcClientInfoQueryHookResult = ReturnType<typeof useGetOidcClientInfoQuery>
export type GetOidcClientInfoLazyQueryHookResult = ReturnType<typeof useGetOidcClientInfoLazyQuery>
export type GetOidcClientInfoQueryResult = Apollo.QueryResult<GetOidcClientInfoQuery, GetOidcClientInfoQueryVariables>
export const CreateOidcClientDocument = gql`
    mutation createOIDCClient($data: OIDCClientCreateInput!) {
...
export const UpdateOidcClientSecretDocument = gql`
    mutation updateOIDCClientSecret($id: ID!, $data: OIDCClientUpdateInput) {
  client: updateOIDCClient(id: $id, data: $data) {
    clientSecret
  }
}
    `
export type UpdateOidcClientSecretMutationFn = Apollo.MutationFunction<UpdateOidcClientSecretMutation, UpdateOidcClientSecretMutationVariables>

/**
 * __useUpdateOidcClientSecretMutation__
 *
 * To run a mutation, you first call `useUpdateOidcClientSecretMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateOidcClientSecretMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateOidcClientSecretMutation, { data, loading, error }] = useUpdateOidcClientSecretMutation({
 *   variables: {
 *      id: // value for 'id'
 *      data: // value for 'data'
 *   },
 * });
 */
export function useUpdateOidcClientSecretMutation (baseOptions?: Apollo.MutationHookOptions<UpdateOidcClientSecretMutation, UpdateOidcClientSecretMutationVariables>) {
    const options = { ...defaultOptions, ...baseOptions }
    return Apollo.useMutation<UpdateOidcClientSecretMutation, UpdateOidcClientSecretMutationVariables>(UpdateOidcClientSecretDocument, options)
}
export type UpdateOidcClientSecretMutationHookResult = ReturnType<typeof useUpdateOidcClientSecretMutation>
export type UpdateOidcClientSecretMutationResult = Apollo.MutationResult<UpdateOidcClientSecretMutation>
export type UpdateOidcClientSecretMutationOptions = Apollo.BaseMutationOptions<UpdateOidcClientSecretMutation, UpdateOidcClientSecretMutationVariables>
export const UpdateOidcClientDocument = gql`
    mutation updateOIDCClient($id: ID!, $data: OIDCClientUpdateInput) {
  client: updateOIDCClient(id: $id, data: $data) {
    id
    developmentRedirectUri
    productionRedirectUri
    ...
    `
export type UpdateOidcClientMutationFn = Apollo.MutationFunction<UpdateOidcClientMutation, UpdateOidcClientMutationVariables>

/**
 * __useUpdateOidcClientMutation__
 *
 * To run a mutation, you first call `useUpdateOidcClientMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateOidcClientMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateOidcClientMutation, { data, loading, error }] = useUpdateOidcClientMutation({
 *   variables: {
 *      id: // value for 'id'
 *      data: // value for 'data'
 *   },
 * });
 */
export function useUpdateOidcClientMutation (baseOptions?: Apollo.MutationHookOptions<UpdateOidcClientMutation, UpdateOidcClientMutationVariables>) {
    const options = { ...defaultOptions, ...baseOptions }
    return Apollo.useMutation<UpdateOidcClientMutation, UpdateOidcClientMutationVariables>(UpdateOidcClientDocument, options)
}
export type UpdateOidcClientMutationHookResult = ReturnType<typeof useUpdateOidcClientMutation>
export type UpdateOidcClientMutationResult = Apollo.MutationResult<UpdateOidcClientMutation>
export type UpdateOidcClientMutationOptions = Apollo.BaseMutationOptions<UpdateOidcClientMutation, UpdateOidcClientMutationVariables>
