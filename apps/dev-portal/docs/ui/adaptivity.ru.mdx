...
Данный хук предназначен для адаптирования всего layout'а целиком. Большинство компонентов Condo UI автоматически адаптируются под данные брейкпоинты,
однако скорее всего вам также захочется изменить их взаимное расположение с помощью данного хука.
