import { AuthenticatedUserQuery, GetActiveOrganizationEmployeeQuery } from '@app/condo/gql'
import condoEn from '@app/condo/lang/en/en.json'
import condoEs from '@app/condo/lang/es/es.json'
import condoRu from '@app/condo/lang/ru/ru.json'
import en from '@app/helpdesk-web/lang/en/en.json'
import es from '@app/helpdesk-web/lang/es/es.json'
import ru from '@app/helpdesk-web/lang/ru/ru.json'


// NOTE: Combine all keys together
const translations = [en, ru, es] as const
const condoTranslations = [condoEn, condoRu, condoEs] as const
type MessagesKeysType = keyof typeof condoTranslations[number] | keyof typeof translations[number]
