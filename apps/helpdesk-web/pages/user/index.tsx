...
import { UserInfoContent, type UserInfoContentProps } from '@helpdesk-web//domains/user/components/UserInfoContent'
import { PageComponentType } from '@helpdesk-web/domains/common/types'
import { UserSettingsContent } from '@helpdesk-web/domains/user/components/UserSettingsContent'
