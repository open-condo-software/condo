...
import { AppEnvironment, useGetB2BAppQuery } from '@/gql'
...
export const EnvironmentInfoSubsection: React.FC<{ id: string }> = ({ id }) => {
    ...
    const SelectStandLabel = intl.formatMessage({ id: 'pages.apps.b2b.id.sections.info.environmentInfo.form.items.stand.label' })
    const AppIdLabel = intl.formatMessage({ id: 'pages.apps.b2b.id.sections.info.environmentInfo.form.items.appId.label' })
    const AppIdPlaceholder = intl.formatMessage({ id: 'pages.apps.b2b.id.sections.info.environmentInfo.form.items.appId.placeholder' })
    const EnvironmentUriLabel = intl.formatMessage({ id: 'pages.apps.b2b.id.sections.info.environmentInfo.form.items.environmentUri.label' })
    ...
    return (
        <Form
            name='update-b2b-app-environment-info-form'
            layout='vertical'
