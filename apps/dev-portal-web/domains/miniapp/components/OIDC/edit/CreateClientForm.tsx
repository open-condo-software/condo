...
export const CreateClientForm: React.FC<CreateClientFormProps> = ({ id, environment }) => {
    const intl = useIntl()
    const NoClientMessage = intl.formatMessage({ id: 'apps.id.sections.oidc.clientSettings.createClientForm.emptyView.message' })
    const NoClientDescription = intl.formatMessage({ id: 'apps.id.sections.oidc.clientSettings.createClientForm.emptyView.description' })
    const CreateClientLabel = intl.formatMessage({ id: 'apps.id.sections.oidc.clientSettings.createClientForm.emptyView.actions.create' })
    const AboutOIDCLabel = intl.formatMessage({ id: 'apps.id.sections.oidc.clientSettings.createClientForm.emptyView.actions.details' })
    const CreateModalTitle = intl.formatMessage({ id: 'apps.id.sections.oidc.clientSettings.createClientForm.modal.title' })
    const RedirectURILabel = intl.formatMessage({ id:'apps.id.sections.oidc.clientSettings.createClientForm.modal.form.items.redirectUri.label' })
    const RedirectURIHintText = intl.formatMessage({ id:'apps.id.sections.oidc.clientSettings.createClientForm.modal.form.items.redirectUri.hint' })
    const SuccessNotificationTitle = intl.formatMessage({ id: 'apps.id.sections.oidc.clientSettings.createClientForm.modal.form.notifications.success.title' })
    const SuccessNotificationDescription = intl.formatMessage({ id: 'apps.id.sections.oidc.clientSettings.createClientForm.modal.form.notifications.success.description' })
