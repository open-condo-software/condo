...
Тип оплаты. Возможные варианты: **online** и **cash**. Это поле носит скорее информационный характер.
...
|------------|----------------------------------------------------------------------------|---------------------|---------------------------------------------------------------------------|
| successUrl | Адрес, на который будет перенаправлен пользователь при успешной оплате     | Строка, url encoded | https%3A%2F%2Fcondo.d.doma.ai%2Fmarketplace%2Finvoice%2Fpayment%2Fsuccess |
| failureUrl | Адрес, на который будет перенаправлен пользователь, если оплата не удалась | Строка, url encoded | https%3A%2F%2Fcondo.d.doma.ai%2Fmarketplace%2Finvoice%2Fpayment%2Ffailure |
| invoiceId  | Идентификатор счета                                                        | Строка, UUID        | 14d5f5c9-de39-4d02-9116-6a2e501e54e1                                      |
