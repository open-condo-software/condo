...
export DATABASE_NAME="announcement"
...
DOCKER_FILE_BUILD_COMMAND=echo yarn workspace @app/announcement build
DOCKER_COMPOSE_APP_IMAGE_TAG=announcement
DOCKER_COMPOSE_START_APP_COMMAND=yarn workspace @app/announcement start
...
docker-compose run app yarn workspace @app/announcement makemigrations

# migrate!
docker-compose run app yarn workspace @app/announcement migrate

# run dev server!
yarn workspace @app/announcement dev
```
...
docker-compose run app yarn workspace @app/announcement kmigrator down
```
...
yarn workspace @app/announcement maketypes
```
