...
const { DEFAULT_LOCALE } = require('@announcement/domains/common/constants')
const { CONDO_ACCESS_TOKEN_KEY, ACCEPT_LANGUAGE, CONDO_REFRESH_TOKEN_KEY } = require('@announcement/domains/condo/constants')
