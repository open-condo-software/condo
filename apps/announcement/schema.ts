...
export type AnnouncementTemplate = {
  __typename?: 'AnnouncementTemplate';
  /**
   * This virtual field will be resolved in one of the following ways (in this order):
   *  1. Execution of 'labelResolver' set on the AnnouncementTemplate List config, or
   *  2. As an alias to the field set on 'labelField' in the AnnouncementTemplate List config, or
   *  3. As an alias to a 'name' field on the AnnouncementTemplate List (if one exists), or
   *  4. As an alias to the 'id' field on the AnnouncementTemplate List.
   */
...
export type AnnouncementTemplateCreateInput = {
  name?: Maybe<Scalars['String']>;
...
/**  A keystone list  */
export type AnnouncementTemplateHistoryRecord = {
  __typename?: 'AnnouncementTemplateHistoryRecord';
  /**
   * This virtual field will be resolved in one of the following ways (in this order):
   *  1. Execution of 'labelResolver' set on the AnnouncementTemplateHistoryRecord List config, or
   *  2. As an alias to the field set on 'labelField' in the AnnouncementTemplateHistoryRecord List config, or
   *  3. As an alias to a 'name' field on the AnnouncementTemplateHistoryRecord List (if one exists), or
   *  4. As an alias to the 'id' field on the AnnouncementTemplateHistoryRecord List.
   */
  _label_?: Maybe<Scalars['String']>;
  name?: Maybe<Scalars['String']>;
  ...
  history_action?: Maybe<AnnouncementTemplateHistoryRecordHistoryActionType>;
  history_id?: Maybe<Scalars['String']>;
};

export type AnnouncementTemplateHistoryRecordCreateInput = {
  name?: Maybe<Scalars['String']>;
  image?: Maybe<Scalars['JSON']>;
  title?: Maybe<Scalars['String']>;
  body?: Maybe<Scalars['String']>;
...
export enum AnnouncementTemplateHistoryRecordHistoryActionType {
  C = 'c',
  U = 'u',
  D = 'd'
}

export type AnnouncementTemplateHistoryRecordUpdateInput = {
  name?: Maybe<Scalars['String']>;
  image?: Maybe<Scalars['JSON']>;
  title?: Maybe<Scalars['String']>;
  body?: Maybe<Scalars['String']>;
...
export type AnnouncementTemplateHistoryRecordWhereInput = {
  AND?: Maybe<Array<Maybe<AnnouncementTemplateHistoryRecordWhereInput>>>;
  OR?: Maybe<Array<Maybe<AnnouncementTemplateHistoryRecordWhereInput>>>;
  name?: Maybe<Scalars['String']>;
  ...
  history_action?: Maybe<AnnouncementTemplateHistoryRecordHistoryActionType>;
  history_action_not?: Maybe<AnnouncementTemplateHistoryRecordHistoryActionType>;
  history_action_in?: Maybe<Array<Maybe<AnnouncementTemplateHistoryRecordHistoryActionType>>>;
  history_action_not_in?: Maybe<Array<Maybe<AnnouncementTemplateHistoryRecordHistoryActionType>>>;
  history_id?: Maybe<Scalars['String']>;
...
export type AnnouncementTemplateHistoryRecordWhereUniqueInput = {
  id: Scalars['ID'];
};

export type AnnouncementTemplateHistoryRecordsCreateInput = {
  data?: Maybe<AnnouncementTemplateHistoryRecordCreateInput>;
};

export type AnnouncementTemplateHistoryRecordsUpdateInput = {
  id: Scalars['ID'];
  data?: Maybe<AnnouncementTemplateHistoryRecordUpdateInput>;
};

export type AnnouncementTemplateUpdateInput = {
  name?: Maybe<Scalars['String']>;
  image?: Maybe<Scalars['Upload']>;
  title?: Maybe<Scalars['String']>;
  body?: Maybe<Scalars['String']>;
...
export type AnnouncementTemplateWhereInput = {
  AND?: Maybe<Array<Maybe<AnnouncementTemplateWhereInput>>>;
  OR?: Maybe<Array<Maybe<AnnouncementTemplateWhereInput>>>;
  name?: Maybe<Scalars['String']>;
  name_not?: Maybe<Scalars['String']>;
  name_contains?: Maybe<Scalars['String']>;
  name_not_contains?: Maybe<Scalars['String']>;
...
export type AnnouncementTemplateWhereUniqueInput = {
  id: Scalars['ID'];
};

export type AnnouncementTemplatesCreateInput = {
  data?: Maybe<AnnouncementTemplateCreateInput>;
};

export type AnnouncementTemplatesUpdateInput = {
  id: Scalars['ID'];
  data?: Maybe<AnnouncementTemplateUpdateInput>;
};
...
export type Mutation = {
  ...
  /**  Create a single AnnouncementTemplateHistoryRecord item.  */
  createAnnouncementTemplateHistoryRecord?: Maybe<AnnouncementTemplateHistoryRecord>;
  /**  Create multiple AnnouncementTemplateHistoryRecord items.  */
  createAnnouncementTemplateHistoryRecords?: Maybe<Array<Maybe<AnnouncementTemplateHistoryRecord>>>;
  /**  Update a single AnnouncementTemplateHistoryRecord item by ID.  */
  updateAnnouncementTemplateHistoryRecord?: Maybe<AnnouncementTemplateHistoryRecord>;
  /**  Update multiple AnnouncementTemplateHistoryRecord items by ID.  */
  updateAnnouncementTemplateHistoryRecords?: Maybe<Array<Maybe<AnnouncementTemplateHistoryRecord>>>;
  /**  Delete a single AnnouncementTemplateHistoryRecord item by ID.  */
  deleteAnnouncementTemplateHistoryRecord?: Maybe<AnnouncementTemplateHistoryRecord>;
  /**  Delete multiple AnnouncementTemplateHistoryRecord items by ID.  */
  deleteAnnouncementTemplateHistoryRecords?: Maybe<Array<Maybe<AnnouncementTemplateHistoryRecord>>>;
  /**  Create a single AnnouncementTemplate item.  */
  createAnnouncementTemplate?: Maybe<AnnouncementTemplate>;
  /**  Create multiple AnnouncementTemplate items.  */
  createAnnouncementTemplates?: Maybe<Array<Maybe<AnnouncementTemplate>>>;
  /**  Update a single AnnouncementTemplate item by ID.  */
  updateAnnouncementTemplate?: Maybe<AnnouncementTemplate>;
  /**  Update multiple AnnouncementTemplate items by ID.  */
  updateAnnouncementTemplates?: Maybe<Array<Maybe<AnnouncementTemplate>>>;
  /**  Delete a single AnnouncementTemplate item by ID.  */
  deleteAnnouncementTemplate?: Maybe<AnnouncementTemplate>;
  /**  Delete multiple AnnouncementTemplate items by ID.  */
  deleteAnnouncementTemplates?: Maybe<Array<Maybe<AnnouncementTemplate>>>;
...
export type MutationCreateAnnouncementTemplateHistoryRecordArgs = {
  data?: Maybe<AnnouncementTemplateHistoryRecordCreateInput>;
};


export type MutationCreateAnnouncementTemplateHistoryRecordsArgs = {
  data?: Maybe<Array<Maybe<AnnouncementTemplateHistoryRecordsCreateInput>>>;
};


export type MutationUpdateAnnouncementTemplateHistoryRecordArgs = {
  id: Scalars['ID'];
  data?: Maybe<AnnouncementTemplateHistoryRecordUpdateInput>;
};


export type MutationUpdateAnnouncementTemplateHistoryRecordsArgs = {
  data?: Maybe<Array<Maybe<AnnouncementTemplateHistoryRecordsUpdateInput>>>;
};


export type MutationDeleteAnnouncementTemplateHistoryRecordArgs = {
  id: Scalars['ID'];
};


export type MutationDeleteAnnouncementTemplateHistoryRecordsArgs = {
  ids?: Maybe<Array<Scalars['ID']>>;
};


export type MutationCreateAnnouncementTemplateArgs = {
  data?: Maybe<AnnouncementTemplateCreateInput>;
};


export type MutationCreateAnnouncementTemplatesArgs = {
  data?: Maybe<Array<Maybe<AnnouncementTemplatesCreateInput>>>;
};


export type MutationUpdateAnnouncementTemplateArgs = {
  id: Scalars['ID'];
  data?: Maybe<AnnouncementTemplateUpdateInput>;
};


export type MutationUpdateAnnouncementTemplatesArgs = {
  data?: Maybe<Array<Maybe<AnnouncementTemplatesUpdateInput>>>;
};


export type MutationDeleteAnnouncementTemplateArgs = {
  id: Scalars['ID'];
};


export type MutationDeleteAnnouncementTemplatesArgs = {
  ids?: Maybe<Array<Scalars['ID']>>;
};
...
export type Query = {
  ...
  /**  Search for all AnnouncementTemplateHistoryRecord items which match the where clause.  */
  allAnnouncementTemplateHistoryRecords?: Maybe<Array<Maybe<AnnouncementTemplateHistoryRecord>>>;
  /**  Search for the AnnouncementTemplateHistoryRecord item with the matching ID.  */
  AnnouncementTemplateHistoryRecord?: Maybe<AnnouncementTemplateHistoryRecord>;
  /**  Perform a meta-query on all AnnouncementTemplateHistoryRecord items which match the where clause.  */
  _allAnnouncementTemplateHistoryRecordsMeta?: Maybe<_QueryMeta>;
  /**  Retrieve the meta-data for the AnnouncementTemplateHistoryRecord list.  */
  _AnnouncementTemplateHistoryRecordsMeta?: Maybe<_ListMeta>;
  /**  Search for all AnnouncementTemplate items which match the where clause.  */
  allAnnouncementTemplates?: Maybe<Array<Maybe<AnnouncementTemplate>>>;
  /**  Search for the AnnouncementTemplate item with the matching ID.  */
  AnnouncementTemplate?: Maybe<AnnouncementTemplate>;
  /**  Perform a meta-query on all AnnouncementTemplate items which match the where clause.  */
  _allAnnouncementTemplatesMeta?: Maybe<_QueryMeta>;
  /**  Retrieve the meta-data for the AnnouncementTemplate list.  */
  _AnnouncementTemplatesMeta?: Maybe<_ListMeta>;
...
export type QueryAllAnnouncementTemplateHistoryRecordsArgs = {
  where?: Maybe<AnnouncementTemplateHistoryRecordWhereInput>;
  search?: Maybe<Scalars['String']>;
  sortBy?: Maybe<Array<SortAnnouncementTemplateHistoryRecordsBy>>;
  orderBy?: Maybe<Scalars['String']>;
  first?: Maybe<Scalars['Int']>;
  skip?: Maybe<Scalars['Int']>;
};
...
export type QueryAnnouncementTemplateHistoryRecordArgs = {
  where: AnnouncementTemplateHistoryRecordWhereUniqueInput;
};


export type Query_AllAnnouncementTemplateHistoryRecordsMetaArgs = {
  where?: Maybe<AnnouncementTemplateHistoryRecordWhereInput>;
  search?: Maybe<Scalars['String']>;
  sortBy?: Maybe<Array<SortAnnouncementTemplateHistoryRecordsBy>>;
  orderBy?: Maybe<Scalars['String']>;
...
export type QueryAllAnnouncementTemplatesArgs = {
  where?: Maybe<AnnouncementTemplateWhereInput>;
  search?: Maybe<Scalars['String']>;
  sortBy?: Maybe<Array<SortAnnouncementTemplatesBy>>;
  orderBy?: Maybe<Scalars['String']>;
  first?: Maybe<Scalars['Int']>;
  skip?: Maybe<Scalars['Int']>;
};
...
export type QueryAnnouncementTemplateArgs = {
  where: AnnouncementTemplateWhereUniqueInput;
};


export type Query_AllAnnouncementTemplatesMetaArgs = {
  where?: Maybe<AnnouncementTemplateWhereInput>;
  search?: Maybe<Scalars['String']>;
  sortBy?: Maybe<Array<SortAnnouncementTemplatesBy>>;
  orderBy?: Maybe<Scalars['String']>;
...
export enum SortAnnouncementTemplateHistoryRecordsBy {
  NameAsc = 'name_ASC',
  NameDesc = 'name_DESC',
  TitleAsc = 'title_ASC',
...
export enum SortAnnouncementTemplatesBy {
  NameAsc = 'name_ASC',
  NameDesc = 'name_DESC',
  TitleAsc = 'title_ASC',
  TitleDesc = 'title_DESC',
