...
const CONDO_B2B_APP_CONTEXT_FIELDS = '{ id status app { id name } organization { id name tin } }'
...
const CONDO_CONFIG = [
    { name: 'B2BAppContext', operations: ['read'], fields: CONDO_B2B_APP_CONTEXT_FIELDS },
