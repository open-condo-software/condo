...
const WEBHOOK_SUBSCRIPTION_FIELDS = `{ webhook { id url user { id } } url syncedAt syncedAmount failuresCount model fields filters maxPackSize operations { create update delete } ${COMMON_FIELDS} }`
