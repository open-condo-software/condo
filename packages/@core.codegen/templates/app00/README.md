...
Generated by https://github.com/8iq/nodejs-hackathon-boilerplate-starter-kit

# quick start

```
git clone https://github.com/8iq/nodejs-hackathon-boilerplate-starter-kit {{ name }}
cd {{ name }}
